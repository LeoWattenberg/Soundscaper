...
export function createDesktopNightlyTestsMetricsPlan({
	...
	return Object.freeze({
		...
		env: Object.freeze({
			...
			SOUNDSCAPER_M3_OBSERVED_ENVIRONMENT_ID: 'local-runtime-diagnostics',
			SOUNDSCAPER_M1_OBSERVED_ENVIRONMENT_ID: 'local-runtime-diagnostics',
			SOUNDSCAPER_M4B2_KEYFRAME_PARITY: '1',
			SOUNDSCAPER_M4_OBSERVED_ENVIRONMENT_ID: 'local-runtime-diagnostics',
