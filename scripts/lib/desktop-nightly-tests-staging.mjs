...
export const NIGHTLY_TEST_PAYLOAD_INPUTS = Object.freeze([
	...
	{ source: 'desktop/nightly-tests-progress-window.mjs', destination: 'desktop/nightly-tests-progress-window.mjs', kind: 'file', label: 'visible nightly test progress window' },
	{ source: 'desktop/nightly-tests-progress.html', destination: 'desktop/nightly-tests-progress.html', kind: 'file', label: 'nightly test progress document' },
	{ source: 'desktop/nightly-tests-progress-renderer.js', destination: 'desktop/nightly-tests-progress-renderer.js', kind: 'file', label: 'nightly test progress renderer' },
	{ source: 'desktop/nightly-tests-progress.css', destination: 'desktop/nightly-tests-progress.css', kind: 'file', label: 'nightly test progress styles' },
	...
	{ source: 'scripts/lib/static-site-content-types.mjs', destination: 'scripts/lib/static-site-content-types.mjs', kind: 'file', label: 'static site content types' },
	...
	{ source: 'scripts/lib/soundscaper-soak-media.mjs', destination: 'scripts/lib/soundscaper-soak-media.mjs', kind: 'file', label: 'packaged soak media fixtures' },
	{ source: 'scripts/lib/soundscaper-soak-playwright.mjs', destination: 'scripts/lib/soundscaper-soak-playwright.mjs', kind: 'file', label: 'packaged soak Playwright session' },
	{ source: 'scripts/lib/soundscaper-soak-scape-custody.mjs', destination: 'scripts/lib/soundscaper-soak-scape-custody.mjs', kind: 'file', label: 'packaged soak foreign-project fixture' },
	{ source: 'scripts/lib/soundscaper-soak-workflows.mjs', destination: 'scripts/lib/soundscaper-soak-workflows.mjs', kind: 'file', label: 'packaged soak workflow driver' },
	...
	// collector, so every spec reaches these five whether or not the packaged
	...
	{ source: 'playwright.nightly-dual-origin.config.mjs', destination: 'playwright.nightly-dual-origin.config.mjs', kind: 'file', label: 'nightly dual-origin coverage Playwright config' },
	{ source: 'playwright.nightly-packaged-coverage.config.mjs', destination: 'playwright.nightly-packaged-coverage.config.mjs', kind: 'file', label: 'nightly packaged-runtime coverage Playwright config' },
	...
	{ source: 'playwright.nightly-local-assistance.config.mjs', destination: 'playwright.nightly-local-assistance.config.mjs', kind: 'file', label: 'real model Electron test config' },
	...
	{ source: '.wrangler/dual-origin-browser/soundscaper', destination: 'sites/soundscaper', kind: 'directory', label: 'verified reciprocal Soundscaper browser site' },
	{ source: '.wrangler/dual-origin-browser/framescaper', destination: 'sites/framescaper', kind: 'directory', label: 'verified reciprocal Framescaper browser site' },
	{ source: '.wrangler/dual-origin-browser/soundscaper-source-maps', destination: 'sites/soundscaper-source-maps', kind: 'directory', label: 'reciprocal Soundscaper browser source maps' },
