...
/** Product-scoped checked-input inventory for Milestone 5 package audits. */

import { MILESTONE_5_PACKAGE_AUDIT_INPUT_PATHS } from './milestone-5-package-audit.mjs';
import {
...
export function milestone5RequiredPackageAuditInputPaths(engineeringScope) {
	const selectedPayloadKeys = new Set(engineeringScope.payloadInputKeys);
	return [
		...Object.entries(MILESTONE_5_PACKAGE_AUDIT_INPUT_PATHS)
