...
export const POLICY_NARRATIVE_BINDINGS = Object.freeze([
	...
	Object.freeze({
		...
		ruleId: 'family-v1-product-isolation',
	...
	Object.freeze({
		marker: 'current-local-assistance-transcript-custody',
		register: 'config/project-compatibility.json',
		ruleId: 'current-local-assistance-transcript-custody',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		marker: 'current-video-retime-baseline',
		register: 'config/project-compatibility.json',
		ruleId: 'current-video-retime-baseline',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		...
		register: 'config/project-compatibility.json',
		ruleId: 'family-v1-foreign-future-custody',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		...
		register: 'config/project-compatibility.json',
		ruleId: 'framescaper-v1-nested-sequence-native',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		...
		register: 'config/project-compatibility.json',
		ruleId: 'framescaper-v1-multicamera-native',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		...
		register: 'config/project-compatibility.json',
		ruleId: 'framescaper-v1-video-proxy-preservation',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		...
		controlId: 'framescaper-v1-editorial-document-admission',
		field: 'summary',
	...
	Object.freeze({
		...
		register: 'config/production-security-matrix.json',
		riskId: 'external-project-document-validation',
		controlId: 'framescaper-v1-keyed-project-admission',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	Object.freeze({
		...
		register: 'config/production-security-matrix.json',
		riskId: 'external-project-document-validation',
		controlId: 'framescaper-v1-foreign-future-custody',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	Object.freeze({
		...
		register: 'config/production-security-matrix.json',
		riskId: 'external-project-document-validation',
		controlId: 'framescaper-v1-keyed-export-authority',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	Object.freeze({
		...
		register: 'config/production-security-matrix.json',
		riskId: 'external-project-document-validation',
		controlId: 'current-video-retime-admission',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	...
	Object.freeze({
		...
		controlId: 'framescaper-v1-desktop-isolation',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	Object.freeze({
		...
		register: 'config/production-security-matrix.json',
		riskId: 'shared-desktop-project-library-integrity',
		controlId: 'family-v1-desktop-library-isolation',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
	...
	Object.freeze({
		marker: 'bounded-freesound-oauth-media-proxy',
		register: 'config/production-security-matrix.json',
		riskId: 'freesound-proxy-boundary',
		controlId: 'bounded-freesound-oauth-media-proxy',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		marker: 'family-v1-desktop-project-libraries',
		register: 'config/project-compatibility.json',
		ruleId: 'current-desktop-project-catalog-commit',
		field: 'currentBehavior',
		document: 'docs/project-compatibility.md',
		intro: null,
		wrap: 80,
	...
	Object.freeze({
		marker: 'fenced-family-v1-project-catalog-publication',
		register: 'config/production-security-matrix.json',
		riskId: 'shared-desktop-project-library-integrity',
		controlId: 'fenced-current-schema-project-catalog-publication',
		field: 'summary',
		document: 'docs/production-threat-model.md',
		intro: null,
	}),
