...
export const DESKTOP_EXPECTED_RUNTIME_FILES = Object.freeze([
	...
	'desktop/local-model-capacity.js', 'desktop/local-model-catalog.js',
	'desktop/local-model-catalog-signature.js', 'desktop/local-model-download.js',
	'desktop/local-model-garbage-collection.js', 'desktop/local-model-install-plan.js',
	'desktop/local-model-notices.js', 'desktop/local-model-preseed.js',
