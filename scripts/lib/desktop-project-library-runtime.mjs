...
export const DESKTOP_EXPECTED_RUNTIME_FILES = Object.freeze([
	...
	'src/common/editor/source-provenance-root.js', 'src/common/editor/source-provenance.js',
	'src/common/editor/stable-id.js', 'src/common/editor/storage/project-storage-profile.js',
