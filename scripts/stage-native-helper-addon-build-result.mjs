...
/** Revalidate and stage one helper build result into an ephemeral checkout. */

import { lstatSync, realpathSync } from 'node:fs';
import { isAbsolute, resolve } from 'node:path';

import { stageNativeHelperAddonBuildResult } from './lib/native-helper-addon-build-result.mjs';

const values = parseArguments(process.argv.slice(2));
const result = await stageNativeHelperAddonBuildResult({
