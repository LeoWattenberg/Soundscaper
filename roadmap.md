...
| Video effects batch 2 | **In progress** | Chroma Key, Luma Key, Spill Suppression, Glow, Outline, and Drop Shadow, including new controls, project migration, preview/export parity, and benchmarks. Move this row to **Implemented** only when the batch lands and its gates pass. |
