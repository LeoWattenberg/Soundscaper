...
/** Shared viewport canvas for rulers backed by frame-indexed tick models. */
export function MappedTimelineRulerCanvas({
	pixelsPerSecond,
	scrollX = 0,
	width,
	viewportWidth,
	...
	useEffect(() => {
		...
		for (const [index, tick] of ticks.entries()) {
			...
			const labelRoom = minorLabelMinimumPixels !== null && (
				!next || (next.frame - tick.frame) / sampleRate * pixelsPerSecond >= minorLabelMinimumPixels
			);
