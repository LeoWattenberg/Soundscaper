...
import { createEditorController } from '../index.js';
import { createAudioEditorFileService } from '../file-service.js';
import { otherProductId, productLocalePath, productProfile } from '../../products.js';
import {
...
} from '../nyquist/plugin-registry.js';
...
function VideoPreviewPanel({ controller, snapshot, copy }) {
	...
	const resolvedLayers = useMemo(() => layers.map((layer) => ({
		...layer,
	...
	useEffect(() => {
		...
		return () => {
			...
			compositorRef.current = null;
			retiredVideoElementsRef.current.length = 0;
		};
