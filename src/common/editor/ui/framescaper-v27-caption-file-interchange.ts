...
export interface FramescaperCaptionSidecarFileV27 {
...
export function captionSidecarFormatForFileNameV27(
	value: string,
...
export async function openFramescaperCaptionSidecarFileV27(input: Readonly<{
	readonly file?: Blob | null;
	readonly fileService?: FramescaperCaptionFileServiceV27;
	readonly signal?: AbortSignal;
}>): Promise<FramescaperCaptionSidecarFileV27 | null> {
	...
	const format = captionSidecarFormatForFileNameV27(fileName);
	let text: string;
	try {
...
export async function saveFramescaperCaptionSidecarFileV27(input: Readonly<{
	readonly fileService: FramescaperCaptionFileServiceV27;
	readonly format: VideoCaptionInterchangeFormatV1;
