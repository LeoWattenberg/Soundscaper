...
import {
	...
	type FramescaperMotionAnalysisTarget,
} from '../../../../framescaper/editor-motion-analysis-actions-finishing.ts';
import {
	framescaperCubeLutActionsFor,
	type FramescaperCubeLutTarget,
} from '../../../../framescaper/editor-cube-lut-actions-finishing.ts';
...
export default function FramescaperFinishingDialog({
	...
	return <AudioEditorDialogShell
		...
		onClose={onClose}
		width={820}
		initialFocus={surface === 'dialogue-chain' ? '[data-dialogue-chain-apply]' : '[data-framescaper-finishing-document]'}
