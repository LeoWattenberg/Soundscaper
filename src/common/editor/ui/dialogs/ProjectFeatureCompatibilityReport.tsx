...
} from './project-feature-compatibility-model.ts';

export interface ProjectFeatureCompatibilityNoticeCopy {
	readonly projectReadOnly: string;
	readonly optionsFor: string;
	readonly resizeFor: string;
	readonly projectCompatibilityReport: string;
	readonly aup4CompatibilityViewReport: string;
	readonly aup4CompatibilityDismiss: string;
...
export interface ProjectFeatureCompatibilityReportProps {
...
export default function ProjectFeatureCompatibilityReport({
	project,
	report,
