...
const REFERENCE_SEEDS: readonly ReferenceSeed[] = Object.freeze([
	...
	['recent-project', 'Recent project', 'File > Recent projects', BOTH],
	['switch-product', 'Edit in the other editor', 'File', BOTH],
	['cancel-switch-product', 'Cancel edit in the other editor', 'File', BOTH],
	...
	['trim-left-edge-to-playhead', 'Trim left edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['trim-right-edge-to-playhead', 'Trim right edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['roll-left-edge-to-playhead', 'Roll left edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['roll-right-edge-to-playhead', 'Roll right edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['ripple-left-edge-to-playhead', 'Ripple left edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['ripple-right-edge-to-playhead', 'Ripple right edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['slip-source-earlier-one-frame', 'Slip source earlier one frame', 'Edit > Clip boundaries', FRAMESCAPER],
	['slip-source-later-one-frame', 'Slip source later one frame', 'Edit > Clip boundaries', FRAMESCAPER],
	['slide-clip-earlier-one-frame', 'Slide clip earlier one frame', 'Edit > Clip boundaries', FRAMESCAPER],
	['slide-clip-later-one-frame', 'Slide clip later one frame', 'Edit > Clip boundaries', FRAMESCAPER],
	['rate-stretch-left-edge-to-playhead', 'Rate stretch left edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['rate-stretch-right-edge-to-playhead', 'Rate stretch right edge to playhead', 'Edit > Clip boundaries', FRAMESCAPER],
	['video-linked-audio', 'Link or unlink audio', 'Edit > Clip boundaries', FRAMESCAPER],
	['video-composition-editor', 'Transform and compositing', 'Edit > Clip boundaries', FRAMESCAPER],
	['video-keyframes-editor', 'Video keyframes', 'Edit > Clip boundaries', FRAMESCAPER],
	['video-retime-editor', 'Video retime', 'Edit > Clip boundaries', FRAMESCAPER],
	['video-proxy-manager', 'Video proxies', 'Edit > Clip boundaries', FRAMESCAPER],
	...
	['workspace-modern', 'Soundscaper workspace', 'View > Workspace', SOUNDSCAPER, 'setting'],
	['workspace-audacity', 'Audacity workspace', 'View > Workspace', SOUNDSCAPER, 'setting'],
	['workspace-music', 'Music workspace', 'View > Workspace', SOUNDSCAPER, 'setting'],
	['workspace-classic', 'Classic workspace', 'View > Workspace', SOUNDSCAPER, 'setting'],
	['workspace-video-editor', 'Video editor workspace', 'View > Workspace', FRAMESCAPER, 'setting'],
	...
	['snap-enabled', 'Snap to grid', 'View > Snap', BOTH, 'setting'],
	['snap-triplets', 'Enable triplets', 'View > Snap', BOTH, 'setting'],
	['snap-bar', 'Bar', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-2', '1/2', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-4', '1/4', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-8', '1/8', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-16', '1/16', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-32', '1/32', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-64', '1/64', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-1-128', '1/128', 'View > Snap > Musical', BOTH, 'setting'],
	['snap-seconds', 'Seconds', 'View > Snap > Time', BOTH, 'setting'],
	['snap-deciseconds', 'Deciseconds', 'View > Snap > Time', BOTH, 'setting'],
	['snap-centiseconds', 'Centiseconds', 'View > Snap > Time', BOTH, 'setting'],
	['snap-milliseconds', 'Milliseconds', 'View > Snap > Time', BOTH, 'setting'],
	['snap-samples', 'Samples', 'View > Snap > Time', BOTH, 'setting'],
	['snap-video-24', 'Video frames (24 fps)', 'View > Snap > Video', BOTH, 'setting'],
	['snap-video-ntsc', 'NTSC frames (29.97 fps)', 'View > Snap > Video', BOTH, 'setting'],
	['snap-video-ntsc-drop', 'NTSC drop frames', 'View > Snap > Video', BOTH, 'setting'],
	['snap-video-pal', 'PAL frames (25 fps)', 'View > Snap > Video', BOTH, 'setting'],
	['snap-cdda', 'CDDA frames (75 fps)', 'View > Snap > CD', BOTH, 'setting'],
	['framescaper-external-display-none', 'No external display', 'View > External display', FRAMESCAPER, 'setting'],
	['framescaper-external-display', 'External display', 'View > External display', FRAMESCAPER, 'setting'],
	['desktop-reload', 'Reload application', 'View', BOTH],
	...
	['audacity-reverb', 'Reverb', 'Effect > Delay and reverb', SOUNDSCAPER],
	...
	['audacity-legacy-compressor', 'Legacy Compressor', 'Effect > Legacy', SOUNDSCAPER],
	['audacity-classic-filters', 'Classic Filters', 'Effect > Legacy', SOUNDSCAPER],
	['audio-warp-editor', 'Audio warp', 'Effect > Pitch and tempo', SOUNDSCAPER],
	...
	['native-audio-device', 'Native audio device', 'Tools > Audio devices', SOUNDSCAPER, 'setting'],
	['native-audio-preferences', 'Native audio and latency', 'Tools > Audio devices', SOUNDSCAPER, 'setting'],
	['framescaper-background-jobs', 'Background jobs', 'Tools', FRAMESCAPER],
	['framescaper-watch-folders', 'Watch folders', 'Tools', FRAMESCAPER],
	['framescaper-proxy-generate', 'Generate proxy', 'Tools > Proxies', FRAMESCAPER],
	['framescaper-proxy-attach', 'Attach proxy', 'Tools > Proxies', FRAMESCAPER],
	['framescaper-proxy-detach', 'Detach proxy', 'Tools > Proxies', FRAMESCAPER],
	['framescaper-proxy-relink', 'Relink proxy', 'Tools > Proxies', FRAMESCAPER],
	...
	['install-application', 'Install application', 'Help', BOTH],
	['debug-storage', 'Debug storage', 'Help', BOTH, 'setting'],
	['desktop-product-help', 'Product help', 'Help', BOTH, 'link'],
