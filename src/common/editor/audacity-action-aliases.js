...
export const AUDACITY_ACTION_ALIASES = deepFreeze({
	...
	'mute-all-tracks': 'local://mute-all',
	'unmute-all-tracks': 'local://unmute-all',
	...
	'sel-prev-clip': 'select-previous-clip',
	'sel-next-clip': 'select-next-clip',
	trim: 'trim-audio-outside-selection',
	'split-new': 'split-into-new-track',
	'add-label-playing': 'label-add',
	'prev-frame': 'track-view-prev-panel',
	toggle: 'track-view-toggle-selection',
	'toggle-alt': 'track-view-toggle-selection',
	'track-menu': 'track-view-item-context-menu',
	'skip-sel-start': 'skip-to-selection-start',
	'skip-sel-end': 'skip-to-selection-end',
});
