...
export function planFrameCanonicalRateStretch(
	...
	if (project.schemaVersion !== AUDIO_EDITOR_PROJECT_V15_SCHEMA_VERSION) {
		throw new RangeError('A frame-canonical rate stretch requires the exact V15 command projection.');
	}
