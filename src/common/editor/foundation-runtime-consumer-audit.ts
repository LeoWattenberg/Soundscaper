...
export const FOUNDATION_RUNTIME_PROJECTION_BOUNDARIES: readonly FoundationRuntimeProjectionBoundary[] = deepFreeze([
	...
	{
		boundary: 'planVideoKeyframeOfflineVideoSources',
		file: 'src/common/editor/ui/video-keyframe-offline-video-export-sources.ts',
		root: false,
		delegate: 'captureVisibleExportProject',
		guardsBrand: false,
	},
	{
		boundary: 'captureVisibleExportProject',
		file: 'src/common/editor/ui/video-keyframe-offline-video-export-sources.ts',
		root: false,
		delegate: 'resolveRuntimeProjectProjection',
		guardsBrand: true,
...
export const FOUNDATION_RUNTIME_SHIELDED_OWNERS: readonly FoundationRuntimeShieldedOwner[] = deepFreeze([
	...
	{ file: 'src/common/editor/ui/video-keyframe-offline-video-export-sources.ts', surfaces: ['video-export'] },
...
export const FOUNDATION_RUNTIME_CONSUMER_SURFACES: readonly FoundationRuntimeConsumerEvidence[] = deepFreeze([
	...
	},
	{
		...
		surface: 'video-export',
		file: 'src/common/editor/ui/video-keyframe-offline-video-export-sources.ts',
		entryPoint: 'planVideoKeyframeOfflineVideoSources',
		inputIdentifier: 'requestValue',
		projectedIdentifier: 'project',
		boundary: 'captureVisibleExportProject',
		evidence: 'Offline source planning preserves an already-branded runtime project or resolves the media projection before selecting visible range-intersecting clip occurrences and sources.',
	},
	{
