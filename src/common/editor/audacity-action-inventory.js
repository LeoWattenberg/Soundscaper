...
const nyquistDefinitions = NYQUIST_BUNDLED_PLUGINS.map((plugin) => {
	...
	const enableWhen = plugin.spectral
		...
		: plugin.category === 'generate' ? 'project-writable'
			: plugin.category === 'legacy' ? 'editable-effect-target' : 'audio-selection-or-clip';
...
export const AUDACITY_ACTION_DEFINITIONS = [
	...
	implemented('action://delete', 'Delete', ['Edit', 'Clip context'], 'edit.delete', { enableWhen: 'editable-delete-target', source: UPSTREAM.trackEdit }),
	...
	implemented('trim-audio-outside-selection', 'Trim audio outside selection', ['Edit > Remove special'], 'edit.trimOutsideSelection', { enableWhen: 'editable-selection-or-clip', source: UPSTREAM.trackEdit }),
	...
	implemented('split', 'Split', ['Edit > Clip', 'Clip context'], 'edit.split', { shortcut: 'S', enableWhen: 'editable-split-target', source: UPSTREAM.trackEdit }),
	...
	implemented('join', 'Join selected clips', ['Edit > Clip'], 'edit.join', { enableWhen: 'joinable-editable-clips', source: UPSTREAM.trackEdit }),
	...
	implemented('rename-item', 'Rename clip', ['Edit > Clip'], 'clip.rename', { enableWhen: 'editable-item-selected' }),
	...
	implemented('label-add', 'Add label', ['Edit > Label'], 'labels.add', { enableWhen: 'editable-label-project', source: UPSTREAM.trackEdit }),
	...
	implemented('set-loop-region-to-selection', 'Set loop to selection', ['Select > Looping'], 'transport.loopToSelection', { enableWhen: 'time-or-clip-selection', source: UPSTREAM.playback }),
	...
	implemented('zero-cross', 'At zero crossings', ['Select'], 'selection.zeroCross', { shortcut: 'Z', enableWhen: 'time-or-clip-selection' }),
	...
	implemented('zoom-to-selection', 'Zoom to selection', ['View > Zoom'], 'timeline.zoomSelection', { enableWhen: 'time-or-clip-selection', source: UPSTREAM.projectScene }),
	...
	implemented('skip-to-selection-end', 'Selection end', ['View > Skip to'], 'selection.skipToSelectionEnd', { enableWhen: 'time-or-clip-selection' }),
	...
	implemented('play-cut-preview', 'Cut preview', ['Transport'], 'transport.playCutPreview', { shortcut: 'C', enableWhen: 'time-selection-and-not-recording', source: null, origin: 'local' }),
	implemented('play-stop-select', 'Play/Stop and set cursor', ['Transport'], 'transport.playStopSelect', { shortcut: 'X', enableWhen: 'project-opened-and-not-recording', source: null, origin: 'local' }),
	...
	implemented('action://playback/pause', 'Pause', ['Transport'], 'transport.pause', { enableWhen: 'playing-or-paused-or-recording', source: UPSTREAM.playback }),
	...
	implemented('curs-sel-start', 'Move playhead to selection start', ['Keyboard navigation'], 'selection.skipToSelectionStart', { enableWhen: 'time-or-clip-selection', source: UPSTREAM.projectScene }),
	implemented('curs-sel-end', 'Move playhead to selection end', ['Keyboard navigation'], 'selection.skipToSelectionEnd', { enableWhen: 'time-or-clip-selection', source: UPSTREAM.projectScene }),
	...
	implemented('effect://builtin/processors', 'Built-in processors', ['Effect'], 'effects.openProcessor', { enableWhen: 'editable-effect-target', source: UPSTREAM.builtinEffects, upstreamAction: 'dynamic processor action' }),
	...
	implemented('manage-macros', 'Macros palette', ['Tools'], 'macros.openPalette', { enableWhen: 'project-opened', source: UPSTREAM.menu }),
	implemented('effect://builtin/change-pitch', 'Change pitch', ['Effect > Pitch and tempo'], 'effects.changePitch', { enableWhen: 'editable-effect-target', source: UPSTREAM.builtinEffects, upstreamAction: 'dynamic Change Pitch effect action' }),
	implemented('effect://builtin/change-tempo', 'Change tempo', ['Effect > Pitch and tempo'], 'effects.changeTempo', { enableWhen: 'editable-effect-target', source: 'au3/lib-src/au3-time-and-pitch/StaffPad/TimeAndPitch.cpp', upstreamAction: 'legacy Change Tempo effect adapted to StaffPad' }),
	implemented('effect://builtin/change-speed-pitch', 'Change speed and pitch', ['Effect > Pitch and tempo'], 'effects.changeSpeedPitch', { enableWhen: 'editable-effect-target', source: 'au3/lib-src/au3-time-and-pitch/StaffPad/TimeAndPitch.cpp', upstreamAction: 'legacy Change Speed and Pitch effect adapted to StaffPad' }),
	implemented('effect://builtin/sliding-stretch', 'Sliding stretch', ['Effect > Pitch and tempo'], 'effects.slidingStretch', { enableWhen: 'editable-effect-target', source: UPSTREAM.builtinEffects, upstreamAction: 'dynamic Sliding Stretch effect action' }),
	...
	disabled('menu-macros', 'Macros', ['Tools'], DISABLED_REASONS.menu, { menuVisible: false }),
	disabled('apply-macros-palette', 'Apply macro', ['Tools > Macros'], DISABLED_REASONS.menu, { menuVisible: false }),
	disabled('macro-fade-ends', 'Fade ends', ['Tools > Macros'], DISABLED_REASONS.menu, { menuVisible: false }),
	disabled('macro-mp3-conversion', 'MP3 conversion', ['Tools > Macros'], DISABLED_REASONS.menu, { menuVisible: false }),
