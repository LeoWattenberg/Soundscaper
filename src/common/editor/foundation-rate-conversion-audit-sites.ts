...
export const FOUNDATION_RATE_CONVERSION_AUDIT_SITES: readonly FoundationTimeConversionSite[] = [
	...
	},
	{
		...
		file: 'src/common/editor/controller/import/internal/incremental-wav-import-service.ts',
	...
	},
	{
		...
		file: 'src/common/editor/controller/import/internal/linked-media/linked-wav-import-service.ts',
	...
	},
	{
		...
		file: 'src/common/editor/controller/source/source-audio.ts',
	...
	},
	{
		...
		file: 'src/common/editor/controller/track-audio/internal/track-transform-service.ts',
	...
	},
	{
		...
		file: 'src/common/editor/controller/import/internal/project-bin/project-bin-runtime.ts',
