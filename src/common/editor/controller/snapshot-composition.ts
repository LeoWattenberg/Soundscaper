...
import { createEditorDocumentSnapshot, createSelectionEffectTypeSnapshot, type EditorDocumentSnapshotRuntime, type SnapshotProject } from './document-snapshot.ts';
import { applyVideoEffectGesturePreviews, createAudioDeviceSnapshot, createEditorTelemetrySnapshot } from './snapshot-model.ts';
import { createSnapshotChannel } from './snapshot-channel.ts';
