...
import type { DocumentHistory, DocumentProject } from './document-composition-types.ts';
import type { FramescaperCaptureAppBindingOptions } from './framescaper-capture-app-binding.ts';
import { admitFramescaperCaptureProject } from './framescaper-capture-project-admission.ts';
import { admitControllerSessionHistory } from './session-history-admission.ts';
