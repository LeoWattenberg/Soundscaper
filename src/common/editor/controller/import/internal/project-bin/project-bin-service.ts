...
import { admitChangedContentAudioCandidate } from '../linked-media/audio-relink-probe.ts';
import {
...
} from '../../../clip-video/linked-video-original-generation.ts';
...
export function createProjectBinService(
	...
	async function dispose(): Promise<void> {
		...
		if (failures.length > 1) throw new AggregateError(failures, 'Project Bin disposal failed.');
	}
}
