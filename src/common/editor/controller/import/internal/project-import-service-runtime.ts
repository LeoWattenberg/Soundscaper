...
export function createProjectImportServiceRuntime(runtime: ProjectImportRuntime) {
	const {
	...
	async function normalizedImportOptionsForUse(value: RuntimeValue) {
		const { normalizeProjectImportOptionsForUse } = await import('./project-import-options-for-use.ts');
