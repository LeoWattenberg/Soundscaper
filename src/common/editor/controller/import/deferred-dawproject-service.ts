...
import type { DawprojectServiceHelpers } from './internal/dawproject/dawproject-service.ts';
...
type DawprojectModule = typeof import('./internal/dawproject/dawproject-service.ts');
...
const DEFAULT_LOADER: DawprojectModuleLoader = () => import('./internal/dawproject/dawproject-service.ts');
