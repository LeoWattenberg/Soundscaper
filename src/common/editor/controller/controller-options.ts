...
import type { RecordingControllerFactory } from './recording-transaction-types.ts';
import type { createRecordingCapturePool } from '../recording.js';
import type { createFramescaperCaptureAdminInterlock } from './framescaper-capture-admin-interlock.ts';
import type { createFramescaperCaptureAppBinding, FramescaperCaptureAppBindingOptions } from './framescaper-capture-app-binding.ts';
import type { CaptureCompositionDependencies, CaptureCompositionRuntime } from './capture-composition.ts';
import type { ClipVideoCompositionDependencies } from './clip-video-composition-types.ts';
...
import type { DocumentCompositionDependencies, DocumentProject, DocumentHistory } from './document-composition-types.ts';
import type { EditCompositionDependencies } from './edit-composition-types.ts';
...
import type { ProjectAdminServiceRuntime } from './project-admin-service.ts';
import type { ProjectLockServiceRuntime } from './project-lock-service.ts';
import type { ControllerProjectRuntimeInput } from './project-runtime.ts';
import type { ProjectSwitchServiceRuntime } from './project-switch-service-types.ts';
import type { ProductNativeRenderInputAuthorityBinding } from './product-native-render-input-authority.ts';
import type { ScapeProjectFileServiceRuntime, ScapeProjectInspection } from './scape-project-file-service.ts';
import type { SourceRuntimeCompositionDependencies } from './source-runtime-composition-types.ts';
import type { TrackAudioCompositionDependencies } from './track-audio-composition-types.ts';
import type { SoundscaperPersistentDeliveryExportRuntime } from './soundscaper-persistent-delivery-runtime-binding.ts';
...
export interface ControllerOptions extends ControllerResourceOptions, ControllerTimerOptions {
	...
	readonly productVideoExportStrategy?: import('./product-video-export-strategy.ts').ProductVideoExportStrategy;
