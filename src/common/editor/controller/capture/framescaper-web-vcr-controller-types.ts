...
import type { WebVcrAudioMonitor } from './internal/web-vcr/web-vcr-audio-monitor.ts';
import type { FramescaperCaptureSourceAdapterId } from './internal/framescaper-capture-source-adapter-router.ts';
