...
} from './internal/browser/framescaper-browser-recorder-factory.ts';
import {
	createBrowserFramescaperCapturePreviewSurface,
	createBrowserFramescaperCaptureLevelMonitor,
} from './internal/browser/framescaper-browser-capture-preview.ts';
import {
...
} from './internal/browser/framescaper-browser-capture-source.ts';
import {
...
} from './internal/framescaper-capture-canonical-publication.ts';
import {
	createFramescaperCaptureDurablePortBinding,
	type FramescaperCaptureDurablePortBinding,
} from './internal/framescaper-capture-durable-port.ts';
import { createFramescaperCaptureDurableSessionCoordinator } from './internal/framescaper-capture-durable-session.ts';
import { finalizeFramescaperCaptureDurability } from './internal/framescaper-capture-durable-finalization.ts';
import {
	createFramescaperCaptureDeviceAdapter,
	type FramescaperCaptureDesktopBridgeV1,
	type FramescaperCaptureDesktopSelection,
} from './internal/framescaper-capture-device-adapter.ts';
import { createFramescaperCaptureOriginGuard } from './framescaper-capture-origin-guard.ts';
import { completeFramescaperCaptureRuntimeProbe } from './internal/framescaper-capture-runtime-probe.ts';
import type { FramescaperCaptureProjectPublicationPort } from './internal/framescaper-capture-project-publication-port.ts';
import type {
	FramescaperCaptureRetryableRecoveryRecord,
} from './internal/framescaper-capture-publication-service.ts';
import type { FramescaperCapturePublicationSequence } from './internal/framescaper-capture-publication-plan.ts';
import { createFramescaperCaptureSessionService } from './internal/framescaper-capture-session-service.ts';
import { createFramescaperCaptureSetupDefaults } from './internal/framescaper-capture-setup-defaults.ts';
import type { FramescaperCaptureStartAdmissionPort } from './internal/framescaper-capture-start-admission.ts';
import { createFramescaperCaptureSourceAdapterRouter } from './internal/framescaper-capture-source-adapter-router.ts';
import { createFramescaperCaptureAssetStreams } from './internal/framescaper-capture-stream-timing.ts';
import type {
...
import { createFramescaperWebVcrCaptureAdapter } from './internal/web-vcr/framescaper-web-vcr-capture-adapter.ts';
import { createFramescaperWebVcrController } from './internal/web-vcr/framescaper-web-vcr-controller.ts';
import type {
...
} from './internal/web-vcr/web-vcr-video-frame-crop.ts';
import {
