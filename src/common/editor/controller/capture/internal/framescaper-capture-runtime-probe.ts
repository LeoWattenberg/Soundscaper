...
import type { FramescaperBrowserRecorderFactoryOptions } from './browser/framescaper-browser-recorder-factory.ts';
import {
	selectFramescaperVideoMimeType,
} from './browser/framescaper-browser-capture-source.ts';
