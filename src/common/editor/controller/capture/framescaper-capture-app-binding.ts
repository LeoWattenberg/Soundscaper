...
import { admitFramescaperCaptureProject as routeProject, type FramescaperCaptureAppProject } from './internal/framescaper-capture-project-admission.ts';
...
} from './internal/framescaper-capture-project-publication-port.ts';
import {
...
} from './internal/framescaper-capture-start-admission.ts';
import type {
...
export type { FramescaperCaptureAppProject } from './internal/framescaper-capture-project-admission.ts';
