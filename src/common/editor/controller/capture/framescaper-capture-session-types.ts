...
import type { FramescaperCaptureSetupDefaults, FramescaperCaptureSetupDefaultsPort } from './internal/framescaper-capture-setup-defaults.ts';
import type {
	FramescaperCaptureArmOptions,
	FramescaperCaptureStateSnapshot,
} from './internal/framescaper-capture-state-machine.ts';
...
export interface FramescaperCaptureSessionServiceOptions<Stream = unknown, Track = unknown> {
	...
	readonly releaseUserAction?: (generation: number) => void;
