...
import { admitTimePitchCacheProject } from './internal/time-pitch-cache-project-admission.ts';
import type { OwnedStateWriteScope } from '../shared/owned-state.ts';
import type { AudioBufferLike } from './source-audio.ts';
import type { ProjectVisualClip, ProjectVisualProject, ProjectVisualSource } from '../document/project-visual-types.ts';
