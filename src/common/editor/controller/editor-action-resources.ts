...
import type { createFramescaperCaptureAppBinding } from './framescaper-capture-app-binding.ts';
...
import type { createControllerSoundActivationPolicy } from './sound-activation-controller-composition.ts';
import type { createEditorTaskProgressCoordinator } from './task-progress.ts';
...
interface EditorActionState extends Record<string, unknown>, MacroState {
	...
	audacityPreviewSource: Partial<Pick<EngineParametricEqPreview, 'readSpectrum' | 'audition'>> | null;
