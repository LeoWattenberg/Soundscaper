...
export function createGroupedEditorActions(scope: EditorActionRuntime) {
	...
	prepareAudacityEffectFromController, previewAudacityEffectFromController,
	previewParametricEq, previewRackEffect, product, getProject,
	...
	setAllTracksView, setAudacityControlTrack, setAudacityEffectParamsFromController,
	...
	setSnapSettings, effectPreviewState, effectSelectionService, setTimelineView, setTimelineViewportWidth,
	setTrackChannelHeightRatio, setTrackDisplayMode,
	...
	const actions = Object.freeze({
		project: Object.freeze({
			...
			openAudacityProject,
			openAup4, openDawproject, openSesx, saveDawproject,
			openScape,
			openScapeFile,
			inspectScape,
			saveAup4,
		...
		timeline: Object.freeze({
			...
			setChannelHeightRatio: setTrackChannelHeightRatio,
			setZoom,
		...
		effects: Object.freeze({
			...
			setSelectionType: restricted('audioEffects', prepareAudacityEffectFromController),
