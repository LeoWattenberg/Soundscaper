...
import type { DocumentProject, DocumentHistory } from '../document/document-composition-types.ts';
...
import type { createMicrophoneMeterService } from '../recording/microphone-meter-service.ts';
import type { createNativeProjectComposition } from '../document/native-project-composition.ts';
import type { createPreferencesComposition } from '../preferences/preferences-composition.ts';
import type { createControllerPresentationState } from './presentation-state.ts';
import type { createProjectAdminService } from '../document/project-admin-service.ts';
import type { createProjectBootstrapComposition } from '../document/project-bootstrap-composition.ts';
import type { createProjectLockService } from '../document/project-lock-service.ts';
import type { createProjectSwitchService } from '../document/project-switch-service.ts';
import type { createRecordingComposition } from '../recording/recording-composition.ts';
import type { createSourceRuntimeComposition } from '../source/source-runtime-composition.ts';
import type { ClipTimePitchRenderEngine } from '../source/clip-time-pitch-service.ts';
import type { createControllerStorageCapacityService } from '../shared/storage-capacity-runtime.ts';
