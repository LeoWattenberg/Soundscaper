...
import type { TakeCycleOpenRecoveryAppPort } from '../recording/take-cycle-open-recovery-app-port.ts';
...
import type { createNativeProjectService } from '../document/native-project-service.ts';
...
import type { createScapeProjectFileService } from '../document/scape-project-file-service.ts';
...
import type { createSettingPersistence } from '../preferences/setting-persistence.ts';
