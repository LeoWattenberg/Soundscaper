...
import type { ScapeInspectionFence } from './internal/scape/scape-inspection-quiescence.ts';
...
import { createImmediateTakeCycleOpenRecoveryProjectPort } from '../recording/take-cycle-open-recovery-app-port.ts';
