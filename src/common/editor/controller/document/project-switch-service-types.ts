...
import type { EditorCancellableHandle, EditorLifetimeToken } from '../shared/lifecycle.ts';
import type { PlaybackProjectService } from '../source/playback-project-service.ts';
import type { ScapeInspectionQuiescence } from './internal/scape/scape-inspection-quiescence.ts';
import type {
...
import type { PreparedProjectSourceInputs, PreparedRequiredProjectSources } from '../source/source-lifecycle-service.ts';
import type { SourceChunkProviderReplacement } from '../source/source-chunk-provider-registry.ts';
import type { TakeCycleOpenRecoveryProjectPort } from '../recording/take-cycle-open-recovery-app-port.ts';
