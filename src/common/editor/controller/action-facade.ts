...
export function createGroupedEditorActions(scope: EditorActionRuntime): RuntimeValue {
	...
	return Object.freeze({
		...
		preferences: Object.freeze({
			...
			setPanel: setPanelPreference, setPanelVisibility: setPanelVisibilityPreference,
			setPanelFrameSize: setPanelFrameSizePreference, setPanelDockExtent: setPanelDockExtentPreference,
			movePanel: movePanelPreference, activatePanelTab: activatePanelTabPreference,
