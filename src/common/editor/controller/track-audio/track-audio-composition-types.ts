...
import type { EditorExportState } from '../export/export-state.ts';
import type { ExportSnapshotRendererRuntime } from '../export/export-snapshot-renderer.ts';
...
import type { MixRenderServiceDependencies } from './internal/mix-render/mix-render-service.ts';
import type {
	SelectionViewCopy,
	SelectionViewProject,
	SelectionViewServiceRuntime,
	SelectionViewState,
} from './internal/selection-view-service-types.d.ts';
import type { TakeCompCompositionDependencies } from './internal/take-comp/take-comp-composition.ts';
...
import type { EditorTrackServiceDependencies, TrackRecordingRoutingPort } from './internal/track-service.ts';
