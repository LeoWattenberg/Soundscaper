...
} from './internal/recording-input-coordination-service.ts';
import {
...
import { createRecordingRoutingService } from './internal/recording-routing-service.ts';
import {
	createRecordingSessionService,
	createRoutedRecordingController,
} from './internal/recording-session-service.ts';
import type {
...
import { createTakeCycleRecordingAppSession } from './internal/take-cycle/take-cycle-recording-app-session.ts';
import { createTimedRecordingInputService } from './internal/timed-recording-input-service.ts';
import { createTimedRecordingService } from './internal/timed-recording-service.ts';
import { peakCacheKey } from '../source/waveform-analysis.ts';
import type {
	RecordingCompositionDependencies,
	RecordingCompositionEngine,
	RecordingCompositionProject,
} from './internal/recording-composition-types.ts';
