...
import type { RecordingControllerLike } from './internal/recording-session-service.ts';
import type {
...
import type { TimedRecordingDescriptor } from './internal/timed-recording-service.ts';
