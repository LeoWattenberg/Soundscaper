...
const GUIDED_GRAPHS = Object.freeze({
	'transcribe-captions': graph([
		...
		stage({ stageId: 'recognize-speech', operation: 'speech-recognition', after: ['detect-speech'],
			inputs: ['audio'], outputs: ['transcript'], models: ['speech-recognizer'] }),
	...
	'clean-filler-silence': graph([
		...
		stage({ stageId: 'recognize-speech', operation: 'speech-recognition', required: false,
			after: ['detect-speech'], inputs: ['audio'], outputs: ['transcript'], models: ['speech-recognizer'] }),
	...
	'index-video': graph([
		...
		stage({ stageId: 'publish-video-index', operation: null,
			after: ['embed-visuals', 'recognize-text'],
			inputs: ['visual-embeddings', 'recognized-text'], outputs: ['video-index'] }),
	]),
	'reframe': graph([
	...
	'make-highlights': graph([
		stage({ stageId: 'gather-signals', operation: null,
			inputs: ['video'], optionalInputs: ['audio', 'transcript', 'shot-boundaries', 'reaction-ranges',
				'embeddings'], outputs: ['highlight-signals'] }),
