...
export const AUDACITY_TRACK_CONTEXT_ACTION_IDS = Object.freeze({
	...
	threeBandWaveform: 'local://track-view-waveform-three-band',
	rainbowWaveform: 'local://track-view-waveform-rainbow',
	waveformSettings: 'local://waveform-visualization-settings',
