...
export function isTimelineAnnotationProjectSchema(value: unknown): value is 11 | 12 | 13 | 14 | 15 {
...
export function isTrackFolderProjectSchema(value: unknown): value is 12 | 13 | 14 | 15 {
...
export function isSourceCharacteristicsProjectSchema(value: unknown): value is 14 | 15 {
	return value === AUDIO_EDITOR_PROJECT_V14_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V15_SCHEMA_VERSION;
}

export function isTrackLockProjectSchema(value: unknown): value is 15 {
