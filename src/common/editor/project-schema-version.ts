...
export function isTimelineAnnotationProjectSchema(value: unknown): value is 11 | 12 | 13 | 14 {
...
export function isTrackFolderProjectSchema(value: unknown): value is 12 | 13 | 14 {
	return value === AUDIO_EDITOR_PROJECT_V12_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V13_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V14_SCHEMA_VERSION;
}

export function isSourceCharacteristicsProjectSchema(value: unknown): value is 14 {
