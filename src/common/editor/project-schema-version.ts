...
/** Historical Framescaper finishing generation and the sole V28 reimport source. */
...
export function isProductionMixerProjectSchema(value: unknown): value is 21 | 23 | 27 | 28 | 29 | 30 | 31 | 32 {
	return isSoundscaperProductionProjectSchema(value)
		...
		|| value === FRAMESCAPER_PROJECT_V32_SCHEMA_VERSION
...
export function isSelectedFramescaperProjectSchema(value: unknown): value is 27 | 28 | 31 | 32 {
...
export function isFramescaperVideoProxyProjectSchema(value: unknown): value is 20 | 27 | 28 | 31 | 32 {
...
export function isFramescaperSequenceProjectSchema(value: unknown): value is 18 | 19 | 20 | 27 | 28 | 31 | 32 {
	return value === 18
...
export function isFramescaperVideoCompositionProjectSchema(value: unknown): value is 19 | 20 | 27 | 28 | 31 | 32 {
...
export function isFramescaperVideoKeyframeProjectSchema(value: unknown): value is 20 | 27 | 28 | 31 | 32 {
	return value === FRAMESCAPER_PROJECT_V20_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V27_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V28_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V32_SCHEMA_VERSION
...
export function isFramescaperVideoRetimeProjectSchema(value: unknown): value is 20 | 27 | 28 | 31 | 32 {
	return value === FRAMESCAPER_PROJECT_V20_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V27_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V28_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V32_SCHEMA_VERSION
...
export function isTimelineAnnotationProjectSchema(value: unknown): value is 17 | 21 | 23 | 27 | 28 | 29 | 30 | 31 | 32 {
	return value === AUDIO_EDITOR_PROJECT_V17_SCHEMA_VERSION
		|| value === SOUNDSCAPER_PROJECT_V21_SCHEMA_VERSION
		|| value === SOUNDSCAPER_PROJECT_V23_SCHEMA_VERSION
		|| value === SOUNDSCAPER_PROJECT_V29_SCHEMA_VERSION
...
export function isMaintainedProjectFeatureSchema(value: unknown): value is 17 | 19 | 20 | 21 | 23 | 27 | 28 | 29 | 30 | 31 | 32 {
	return value === AUDIO_EDITOR_PROJECT_V17_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V19_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V20_SCHEMA_VERSION
		|| value === FRAMESCAPER_PROJECT_V27_SCHEMA_VERSION
...
export function isMaintainedRenderedFallbackProjectSchema(value: unknown): value is 17 | 19 | 20 | 21 | 23 | 27 | 28 | 29 | 30 | 31 | 32 {
