...
export function isTimelineAnnotationProjectSchema(value: unknown): value is 11 | 12 | 13 | 14 | 15 | 16 | 17 {
...
export function isTrackFolderProjectSchema(value: unknown): value is 12 | 13 | 14 | 15 | 16 | 17 {
...
export function isSourceCharacteristicsProjectSchema(value: unknown): value is 14 | 15 | 16 | 17 {
...
export function isTrackLockProjectSchema(value: unknown): value is 15 | 16 | 17 {
	return value === AUDIO_EDITOR_PROJECT_V15_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V16_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V17_SCHEMA_VERSION;
}

export function isVideoRetimeCurveProjectSchema(value: unknown): value is 16 | 17 {
	return value === AUDIO_EDITOR_PROJECT_V16_SCHEMA_VERSION
		|| value === AUDIO_EDITOR_PROJECT_V17_SCHEMA_VERSION;
}

export function isTakeCompProjectSchema(value: unknown): value is 17 {
