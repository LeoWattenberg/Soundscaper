...
export const PROJECT_FEATURE_CAPABILITY_IDS = Object.freeze({
	...
	ofxEffects: 'org.soundscaper.capability.openfx-effects',
	...
	videoTransitionDissolve: 'org.soundscaper.capability.video-transition.dissolve',
	videoTransitions: 'org.soundscaper.capability.video-transitions',
	sourceCharacteristics: 'org.soundscaper.capability.source-characteristics',
	masteringSequences: 'org.soundscaper.capability.mastering-sequences',
	immersiveAdm: 'org.soundscaper.capability.immersive-adm',
} as const);
