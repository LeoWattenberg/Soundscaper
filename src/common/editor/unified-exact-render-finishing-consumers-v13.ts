...
function invertMotion(value: VideoSimilarityTransformV1): VideoSimilarityTransformV1 {
...
function channelFrame(frame: UnifiedExactRenderRgbaFrameV13, channel: number): GrayVideoFrameV1 {
...
function writeChannel(pixels: Uint8Array, channel: number, frame: GrayVideoFrameV1): void {
