...
export function fadeEnvelope(
	...
	return evaluateClipFadeAt(localFrame, durationFrames, fadeInFrames, 'in', fadeInShape)
		* evaluateClipFadeAt(localFrame, durationFrames, fadeOutFrames, 'out', fadeOutShape);
}
