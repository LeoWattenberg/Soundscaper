...
const ENTRIES = Object.freeze([
	...
	['localDiagnosticsDescription', 'Create a bounded report of versions, capabilities, typed errors, storage, library, and recovery state.', 'Erstellt einen begrenzten Bericht zu Versionen, Funktionen, Fehlertypen, Speicher, Bibliothek und Wiederherstellung.'],
