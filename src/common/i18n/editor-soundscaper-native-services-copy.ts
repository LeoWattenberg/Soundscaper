...
export const SOUNDSCAPER_NATIVE_SERVICES_COPY = Object.freeze({
	...
	pluginParametersTitle: 'Plug-in parameters',
	pluginParametersLoading: 'Loading plug-in parameters',
	pluginParametersUnavailable: 'Plug-in parameters are unavailable.',
