...
export const CLIP_PROPERTIES_COPY_BY_LOCALE = Object.freeze({
	de: Object.freeze({
			...
			uploadClipToFreesound: 'Clip zu Freesound hochladen',
			frames: 'Frames',
			clipGain: 'Clip-Verstärkung',
			volumeEnvelope: 'Lautstärkehüllkurve',
			fadeIn: 'Einblendung',
			fadeOut: 'Ausblendung',
			fadeInShape: 'Einblendungskurve',
			fadeOutShape: 'Ausblendungskurve',
			legacyLinearFadeShape: 'Lineare Kurve (älteres Projekt)',
			reverse: 'Rückwärts',
	...
	en: Object.freeze({
			...
			uploadClipToFreesound: 'Upload clip to Freesound',
			frames: 'Frames',
			clipGain: 'Clip gain',
			volumeEnvelope: 'Volume envelope',
			fadeIn: 'Fade in',
			fadeOut: 'Fade out',
			fadeInShape: 'Fade in shape',
			fadeOutShape: 'Fade out shape',
			legacyLinearFadeShape: 'Linear curve (older project)',
			reverse: 'Reverse',
