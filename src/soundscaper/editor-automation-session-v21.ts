...
import type {
	SoundscaperAutomationAuthorityV21,
	SoundscaperAutomationGestureReleaseV21,
	SoundscaperAutomationGestureTokenV21,
	SoundscaperAutomationPreviewV21,
	SoundscaperAutomationSessionPortsV21,
	SoundscaperAutomationSessionSnapshotV21,
	SoundscaperAutomationSessionV21,
	SoundscaperAutomationTargetV21,
} from './editor-automation-session-v21-types.ts';

export type {
	SoundscaperAutomationAuthorityV21,
	SoundscaperAutomationGestureReleaseV21,
	SoundscaperAutomationGestureTokenV21,
	SoundscaperAutomationLaneSetCommandV21,
	SoundscaperAutomationPreviewV21,
	SoundscaperAutomationSessionPortsV21,
	SoundscaperAutomationSessionSnapshotV21,
	SoundscaperAutomationSessionV21,
 ...
 */
export function createSoundscaperAutomationSessionV21<Result = unknown>(
	ports: SoundscaperAutomationSessionPortsV21<Result>,
): SoundscaperAutomationSessionV21<Result> {
	assertPorts(ports);
	...
	function getSnapshot(): SoundscaperAutomationSessionSnapshotV21 {
	...
	function previewGesture(
		gestureToken: SoundscaperAutomationGestureTokenV21,
		controlValue: number,
		frame?: number,
	): SoundscaperAutomationPreviewV21 {
		assertActive();
	...
	function cancelGesture(gestureToken?: SoundscaperAutomationGestureTokenV21): boolean {
		assertActive();
	...
	function createSession(
		target: SoundscaperAutomationTargetV21,
		current: SoundscaperAutomationAuthorityV21,
	...
	function resetForAuthority(current: SoundscaperAutomationAuthorityV21, restore: boolean): void {
	...
	function frameAuthority(frame?: number): SoundscaperAutomationAuthorityV21 {
		const current = authority(ports.captureAuthority());
	...
	function assertGesture(gestureToken: SoundscaperAutomationGestureTokenV21): CaptureSession {
...
function assertPorts<Result>(ports: SoundscaperAutomationSessionPortsV21<Result>): void {
...
function authority(value: SoundscaperAutomationAuthorityV21): SoundscaperAutomationAuthorityV21 {
...
function token(session: CaptureSession): SoundscaperAutomationGestureTokenV21 {
	return Object.freeze({
...
function assertToken(session: CaptureSession, value: SoundscaperAutomationGestureTokenV21): void {
...
function requiredTempoMap(current: SoundscaperAutomationAuthorityV21): HoldTempoMap {
