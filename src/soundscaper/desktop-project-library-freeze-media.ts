...
import {
	SOUNDSCAPER_DESKTOP_MAXIMUM_CHUNK_BYTES,
	validateSoundscaperDesktopBodyChunk,
...
export interface SoundscaperDesktopFreezeStore {
...
export interface SoundscaperDesktopFreezeAcquisition {
...
export async function acquireSoundscaperDesktopFreezeBodies(
...
export async function streamSoundscaperDesktopFreezeBody(
	project: SoundscaperProject,
	body: Readonly<SoundscaperDesktopBody>,
	store: Pick<SoundscaperDesktopFreezeStore, 'readSourceChunks'>,
...
async function acquireBody(
	...
	body: Readonly<SoundscaperDesktopBody>,
	bridge: Pick<SoundscaperDesktopRendererBridge, 'readBodyChunk'>,
	store: Pick<SoundscaperDesktopFreezeStore, 'beginSourceWrite'>,
	signal?: AbortSignal,
		...
		async getData(
			...
			try {
				for (let offset = 0; offset < body.byteLength;) {
					...
					const bytes = validateSoundscaperDesktopBodyChunk(await bridge.readBodyChunk({
