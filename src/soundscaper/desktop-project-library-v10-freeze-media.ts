...
export interface SoundscaperDesktopV10FreezeStore {
...
export interface SoundscaperDesktopV10FreezeAcquisition {
...
export async function acquireSoundscaperDesktopV10FreezeBodies(
	...
	store: SoundscaperDesktopV10FreezeStore,
	signal?: AbortSignal,
): Promise<SoundscaperDesktopV10FreezeAcquisition> {
...
function preflightBodies(snapshot: Readonly<SoundscaperDesktopV10BundleSnapshot>): void {
...
async function acquireBody(
	...
	body: Readonly<SoundscaperDesktopV10Body>,
	bridge: Pick<SoundscaperDesktopV10RendererBridge, 'readBodyChunk'>,
	store: Pick<SoundscaperDesktopV10FreezeStore, 'beginSourceWrite'>,
	signal?: AbortSignal,
		...
		async getData(
			...
			try {
				for (let offset = 0; offset < body.byteLength;) {
					...
					const bytes = validateSoundscaperDesktopV10BodyChunk(await bridge.readBodyChunk({
