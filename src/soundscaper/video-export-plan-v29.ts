...
export interface SoundscaperVideoKeyframeExportPlanRequestV29 {
...
/** Build one exact V7 plan from selected Soundscaper V29 runtime authority. */
export function createSoundscaperVideoKeyframeExportPlanV29(
	runtime: Pick<ControllerProjectRuntime, 'projectForRuntimeConsumers'>,
	project: Readonly<Record<string, unknown>>,
	request: SoundscaperVideoKeyframeExportPlanRequestV29,
	...
	assertSoundscaperVideoKeyframeExportCanvasAuthorityV29(canvas, inventory);
...
export function assertSoundscaperVideoKeyframeExportCanvasAuthorityV29(
	canvas: ExactCanvas,
