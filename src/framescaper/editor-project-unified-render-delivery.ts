...
/** Baseline delivery projection over the validated Framescaper render graph. */
...
import {
	createFramescaperUnifiedRenderFinishingNodeNativeMedia,
} from './editor-project-unified-render-plan-native-media.ts';
import { createFramescaperCompanionAudioProjectScopeV15 } from './editor-project-companion-audio-scope.ts';
...
import {
	createFramescaperCaptionDeliveryAdapter,
	snapshotFramescaperCaptionDeliveryRequest,
	type FramescaperCaptionDeliveryAdapter,
	type FramescaperCaptionDeliveryRequest,
} from './video-caption-delivery.ts';
...
export interface FramescaperProjectDeliveryAuthorityV15 {
	...
	readonly captionRequest?: FramescaperCaptionDeliveryRequest | null;
...
/**
 * Build the baseline graph, validate it once as V14, then add only V15's
...
function createCaptionAdapter(
	...
	request: FramescaperCaptionDeliveryRequest,
	...
	return createFramescaperCaptionDeliveryAdapter(track, request, {
