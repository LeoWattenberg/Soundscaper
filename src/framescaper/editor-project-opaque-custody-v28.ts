...
export interface FramescaperOpaqueCustodyProjectV28 extends Readonly<Record<string, unknown>> {
	readonly id: string;
...
export interface FramescaperOpaqueCustodyConsumerProjectV28 extends Readonly<Record<string, unknown>> {
	readonly id: string;
	readonly title: string;
...
export function snapshotFramescaperOpaqueCustodyProjectV28(
	value: unknown,
): FramescaperOpaqueCustodyProjectV28 {
	...
	return project as FramescaperOpaqueCustodyProjectV28;
}
 ...
 */
export function createFramescaperOpaqueCustodyConsumerProjectV28(
	value: unknown,
): FramescaperOpaqueCustodyConsumerProjectV28 {
	...
	}) as FramescaperOpaqueCustodyConsumerProjectV28;
}
