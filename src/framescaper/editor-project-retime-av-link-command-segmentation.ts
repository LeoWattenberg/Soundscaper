...
/** Keep a fresh linked video and its audio peer in one inherited composition segment. */
export function framescaperRetimeFreshVideoAddAvLinkIds(command: unknown): readonly string[] {
...
export function framescaperRetimeSegmentContainsAvLinkPeer(
...
export function framescaperRetimeSegmentContainsAvLinkPair(
	commands: readonly unknown[],
	avLinkId: string,
): boolean {
