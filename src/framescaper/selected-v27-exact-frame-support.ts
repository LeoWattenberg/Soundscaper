...
/** Pixel, grade, capture, and composition-ordering helpers for the selected V27 exact frame execution. */
 ...
 */
export interface TrackOrderBucketV27 {
...
export function requiredInterpretation(
	...
	if (!result) throw new ReferenceError(`Selected V27 source interpretation ${sourceId} is unavailable.`);
	return result;
}
