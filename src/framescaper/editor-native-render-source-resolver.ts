...
/** Mixed HTML-video/native-sequence resolution for the selected nativeMedia Web carrier. */
...
export interface FramescaperNativeCarrierSourceResolverNativeMedia {
	readonly resolveSource: VideoKeyframeOfflineSourceResolver;
	dispose(): PromiseLike<void> | void;
}

export interface FramescaperNativeCarrierSourceResolverDependenciesNativeMedia {
...
export function createFramescaperNativeCarrierSourceResolverNativeMedia(
	assets: readonly VideoKeyframeOfflineHtmlVideoSourceAsset[],
	project: FramescaperProjectNativeMedia,
	dependencies: FramescaperNativeCarrierSourceResolverDependenciesNativeMedia,
): FramescaperNativeCarrierSourceResolverNativeMedia {
