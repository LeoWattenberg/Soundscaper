...
import {
	...
	type FramescaperSelectedVisualAuthoringFenceFinishing,
...
export interface FramescaperSelectedFreezeCaptureRequestFinishing {
...
export interface FramescaperSelectedFreezeCaptureFinishing {
	readonly capture: (request: FramescaperSelectedFreezeCaptureRequestFinishing) => Promise<Readonly<{
		readonly blob: Blob; readonly width: number; readonly height: number;
	}>>;
}

export interface FramescaperSelectedPreparedVisualAuthoringFinishing {
	readonly command: unknown;
	readonly rollback?: () => Promise<void>;
}

export interface FramescaperSelectedVisualAuthoringRequestFinishing {
...
export async function prepareFramescaperSelectedVisualAuthoringFinishing(input: Readonly<{
	...
	assertFramescaperSelectedVisualAuthoringFenceFinishing(project, request.fence, clipId);
