...
export interface FramescaperVideoProxyCleanupPortsRetime {
...
export interface FramescaperVideoProxyCleanupClaimRetime {
...
export interface FramescaperVideoProxyCleanupStoreRetime {
...
/**
 * Crash-resumable reclamation for selected retime/finishing editorial proxy replacements.
 *
 ...
 */
export class FramescaperVideoProxyCleanupCoordinatorRetime {
	readonly #ports: FramescaperVideoProxyCleanupPortsRetime;
	#tail: Promise<void> = Promise.resolve();

	constructor(ports: FramescaperVideoProxyCleanupPortsRetime) {
	...
	): Promise<Readonly<FramescaperVideoProxyCleanupClaimRetime>> {
	...
	async #drain(
		initialClaim: Readonly<FramescaperVideoProxyCleanupClaimRetime>,
	...
	async #journal(): Promise<readonly Readonly<FramescaperVideoProxyCleanupClaimRetime>[]> {
...
export function createFramescaperVideoProxyCleanupCoordinatorRetime(
	bodyStore: FramescaperVideoProxyCleanupStoreRetime,
	projectStore: FramescaperVideoProxyCleanupProjectStoreRetime,
...
): Readonly<FramescaperVideoProxyCleanupClaimRetime> {
...
function normalizeJournal(
	value: unknown,
): readonly Readonly<FramescaperVideoProxyCleanupClaimRetime>[] {
...
function normalizeClaim(value: unknown): Readonly<FramescaperVideoProxyCleanupClaimRetime> {
...
async function currentProjects(
	ports: FramescaperVideoProxyCleanupPortsRetime,
	currentProject: unknown,
