...
/** Exact composition product capabilities. Geometry remains distinct from legacy compositing. */
export const FRAMESCAPER_COMPOSITION_PROJECT_FEATURE_CAPABILITY_PROFILE =
	createEditorProjectFeatureCapabilityProfile({
		owner: 'framescaper',
		registrations: [
