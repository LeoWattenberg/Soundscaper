...
export interface FramescaperImageBatchPlacementRequestTimelineImage {
	readonly sequenceStartFrame: number;
	readonly sequenceFrameCounts: readonly number[];
	readonly createId: (prefix: string) => string;
}

export interface FramescaperImageBatchPlacementTimelineImage {
...
export function createFramescaperImageBatchPlacementTimelineImage(
	projectValue: FramescaperProjectTimelineImage | unknown,
	request: FramescaperImageBatchPlacementRequestTimelineImage,
): FramescaperImageBatchPlacementTimelineImage {
	assertFramescaperProjectIdentity(projectValue);
	const project = record(projectValue, 'Framescaper timelineImage image placement project');
