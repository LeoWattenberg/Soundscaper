...
export interface FramescaperSelectedMotionAcceleratorAdmissionFinishing {
...
export async function createFramescaperSelectedMotionAcceleratorFinishing(
	createCanvas?: () => unknown,
): Promise<FramescaperSelectedMotionAcceleratorAdmissionFinishing> {
