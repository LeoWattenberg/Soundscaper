...
/** Detach V32 and V28 authority before asking an immutable V27 consumer. */
export function framescaperProjectV27FoundationShapeV32(project: unknown): FramescaperProjectV27 {
	return framescaperProjectV27FoundationShapeV28(framescaperProjectV28FoundationShapeV32(project));
}

/** Detach V32 image authority before asking the immutable V28 validator. */
export function framescaperProjectV28FoundationShapeV32(project: unknown): FramescaperProjectV28 {
	const foundation = structuredClone(record(project, 'Framescaper V32 project'));
