 ...
 * longer exists.
 *
 * That rule is not invented here. `validateFramescaperProjectV18` already
...
export function framescaperVideoProxyAttachmentsV18(
	project: unknown,
 ...
 */
export function retainFramescaperVideoProxyAttachmentsV18(
	commanded: unknown,
