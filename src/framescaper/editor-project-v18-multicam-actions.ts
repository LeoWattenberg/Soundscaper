...
/** Bind the exact V18 multicamera command spellings without a generic command escape hatch. */
export function createFramescaperMulticameraActionsV18(
	executeValue: ((command: FramescaperProjectCommandV18) => unknown) | unknown,
): Readonly<FramescaperMulticameraActionsV18> {
	...
	return Object.freeze({
		createMulticamera(projectIdValue: unknown, revisionValue: unknown, groupValue: unknown): unknown {
			...
			} satisfies FramescaperMulticameraCommandV18));
		},
		updateMulticamera(
...
function group(value: unknown): FramescaperMulticameraGroupV18 {
...
function member(value: unknown, groupId: string, index: number): FramescaperMulticameraMemberV18 {
