...
export interface FramescaperNestedVideoRetimeRequestSequence {
...
export function materializeFramescaperNestedVideoRetimeSequence(
	requestValue: FramescaperNestedVideoRetimeRequestSequence | unknown,
...
function requestRecord(value: unknown): FramescaperNestedVideoRetimeRequestSequence {
