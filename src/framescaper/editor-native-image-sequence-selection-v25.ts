...
export interface SelectFramescaperDesktopImageSequenceV25Options {
 ...
 */
export async function selectFramescaperDesktopImageSequenceV25(
	options: SelectFramescaperDesktopImageSequenceV25Options,
): Promise<FramescaperImageSequenceSelectionV25 | null> {
