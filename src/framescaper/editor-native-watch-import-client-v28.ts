...
export interface FramescaperNativeWatchImportControllerV28 {
...
export interface FramescaperNativeWatchImportClientV28Options {
	readonly controller: FramescaperNativeWatchImportControllerV28;
...
export interface FramescaperNativeWatchImportClientV28 {
...
export function createFramescaperNativeWatchImportClientV28(
	...
	async function poll(): Promise<boolean> {
		...
		try {
			...
			committed ??= before;
			if (committed === before) throw new Error('A watch claim carried no pending selected-V28 work.');
