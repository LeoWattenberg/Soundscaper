...
export interface FramescaperImageBatchPlacementRequestV30 {
	readonly sequenceStartFrame: number;
	readonly sequenceFrameCounts: readonly number[];
	readonly createId: (prefix: string) => string;
}

export interface FramescaperImageBatchPlacementV30 {
...
export function createFramescaperImageBatchPlacementV30(
	projectValue: FramescaperProjectV30 | unknown,
