...
import {
	...
	type FramescaperMulticameraMemberSequence,
...
/**
 * Resolve persisted multicamera outputs into a detached exact-sequence transient.
 ...
 */
export function materializeFramescaperMulticameraPlaybackProjectSequence(
	...
	const canonical = projectValue as FramescaperProjectSequence;
	const groups = validateFramescaperMulticameraGroupsSequence(
		profile,
		canonical,
	...
	return deepFreeze(draft) as unknown as FramescaperProjectSequence;
}

function activeMember(group: FramescaperMulticameraGroupSequence): FramescaperMulticameraMemberSequence {
