...
export interface EditorProjectRuntimeV27Selection {
	...
	readonly executeCommand: (history: FramescaperProjectHistoryV27, command: FramescaperProjectCommandV27, options?: Readonly<{ now?: Date | string }>) => FramescaperProjectHistoryV27;
	readonly undo: (history: FramescaperProjectHistoryV27, options?: Readonly<{ now?: Date | string }>) => FramescaperProjectHistoryV27;
	readonly redo: (history: FramescaperProjectHistoryV27, options?: Readonly<{ now?: Date | string }>) => FramescaperProjectHistoryV27;
	readonly canUndo: (history: FramescaperProjectHistoryV27) => boolean;
	readonly canRedo: (history: FramescaperProjectHistoryV27) => boolean;
...
export function createEditorProjectRuntimeV27Selection(
	...
	const selection: EditorProjectRuntimeV27Selection = {
		...
		executeCommand: (history, command, options = {}) => executeFramescaperProjectCommandV27(profile, history, command, options),
		undo: (history, options = {}) => undoFramescaperProjectCommandV27(profile, history, options),
		redo: (history, options = {}) => redoFramescaperProjectCommandV27(profile, history, options),
