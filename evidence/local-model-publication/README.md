...
or proof of catalog publication, installation, inference, or all-platform support.
The digest-pinned production catalog remains the installation authority. All eight
additional model artifacts have retained public readbacks. See
`docs/local-model-release-setup.md` for the exact review handoff.
