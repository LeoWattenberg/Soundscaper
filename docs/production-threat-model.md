...
roles remain open — for the track role only editor playback, maintained
delivery, and portable `.scape` round-trip are qualified, not managed handoff —
as do publisher
