...
Cross-store/process coordination, relink or watch, audio range playback,
packaged executable or operating-system behavior, third-party activation
gating, and legacy private libraries remain outside the claim.
