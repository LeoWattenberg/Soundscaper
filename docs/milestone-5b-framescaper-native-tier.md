...
> activation candidate and exposes no M5 native-media or OpenFX adapter. V20
> through V26 labels below identify historical foundations, candidate contracts,
> typed errors, or dormant custody—not the selected product route. V25/V26 stay
> recognized, opaque, read-only, and no 5B activation is claimed.
