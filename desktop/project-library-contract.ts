...
export const DESKTOP_LIBRARY_SCHEMA_VERSION = 5 as const;
export const DESKTOP_LIBRARY_PROJECT_SCHEMA_VERSION = 13 as const;
...
const LIBRARY_SCOPE = Object.freeze(['kw.media', 'scape-project-library', 'v5']);
