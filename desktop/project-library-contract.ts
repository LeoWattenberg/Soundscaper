...
export const DESKTOP_LIBRARY_SCHEMA_VERSION = 6 as const;
export const DESKTOP_LIBRARY_PROJECT_SCHEMA_VERSION = 14 as const;
...
const LIBRARY_SCOPE = Object.freeze(['kw.media', 'scape-project-library', 'v6']);
