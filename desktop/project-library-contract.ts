...
export const DESKTOP_LIBRARY_SCHEMA_VERSION = 4 as const;
export const DESKTOP_LIBRARY_PROJECT_SCHEMA_VERSION = 12 as const;
...
const LIBRARY_SCOPE = Object.freeze(['kw.media', 'scape-project-library', 'v4']);
