...
/** Add V18-only writer, publication, and immutable-V17 import state. */
export function initializeFramescaperDesktopProjectLibraryV18LifecycleDatabase(
	...
	database.exec(`
		...
		CREATE TABLE IF NOT EXISTS v17_import (
			singleton INTEGER PRIMARY KEY CHECK (singleton = 1),
