...
export interface FramescaperNativePublicationFenceV3Options {
	...
	readonly authorized: (record: NativeQueueRecordV3) => boolean;
}

export class FramescaperNativePublicationFenceServiceV3 {
	readonly #options: FramescaperNativePublicationFenceV3Options;

	constructor(options: FramescaperNativePublicationFenceV3Options) {
	...
	#assertDurable(record: NativeQueueRecordV3, root: FramescaperNativeRootGrant): void {
