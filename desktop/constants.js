...
export const IPC = Object.freeze({
	...
	nativePluginSelectInstallation: 'soundscaper:v1:native-plugin:installation:select',
	...
	nativeVampInventory: 'soundscaper:v1:native-vamp:inventory',
	nativeVampSessionStart: 'soundscaper:v1:native-vamp:session:start',
	nativeVampSessionConfigure: 'soundscaper:v1:native-vamp:session:configure',
	nativeVampSessionPush: 'soundscaper:v1:native-vamp:session:push',
	nativeVampSessionFinish: 'soundscaper:v1:native-vamp:session:finish',
	nativeVampSessionCancel: 'soundscaper:v1:native-vamp:session:cancel',
	...
	assistanceWorkflowStage: 'soundscaper:v1:assistance:workflow:stage',
	assistanceWorkflowInputPort: 'soundscaper:v1:assistance:workflow:input-port',
	assistanceWorkflowReserve: 'soundscaper:v1:assistance:workflow:reserve',
	...
	assistanceSemanticSearchOpen: 'soundscaper:v1:assistance:semantic-search:open',
	assistanceSemanticSearchAuthorize: 'soundscaper:v1:assistance:semantic-search:authorize',
	assistanceSemanticSearchRevoke: 'soundscaper:v1:assistance:semantic-search:revoke',
	assistanceSemanticSearchQuery: 'soundscaper:v1:assistance:semantic-search:query',
	assistanceSemanticSearchCancelQuery: 'soundscaper:v1:assistance:semantic-search:cancel-query',
