...
/** Add V19-only writer, publication, and immutable-V18 import state. */
export function initializeFramescaperDesktopProjectLibraryV19LifecycleDatabase(
	...
	database.exec(`
		...
		CREATE TABLE IF NOT EXISTS v18_import (
			singleton INTEGER PRIMARY KEY CHECK (singleton = 1),
