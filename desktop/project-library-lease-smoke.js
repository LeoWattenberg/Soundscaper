...
import { executeDesktopRendererSmoke } from './renderer-smoke-execution.js';
...
function execute(webContents, plan) {
	...
	return executeDesktopRendererSmoke(webContents, {
		productId: plan.productId,
		operation: 'project-library-lease',
		arguments: [rendererPlan],
		userGesture: true,
	});
}
