...
/** Add V20-only writer, publication, and immutable-V19 import state. */
export function initializeFramescaperDesktopProjectLibraryV20LifecycleDatabase(
	...
	database.exec(`
		...
		CREATE TABLE IF NOT EXISTS v19_import (
			singleton INTEGER PRIMARY KEY CHECK (singleton = 1),
