...
const CODEC_FILES = Object.freeze({
	...
	lame: Object.freeze({
		...
		wasmBytes: 214_198,
		wasmSha256: 'e8ca1786d95a56ead1fc2294be98ea68d31eed5837abd79d2a3322a0af946c6f',
	}),
	mpg123: Object.freeze({
		...
		wasmBytes: 173_764,
		wasmSha256: '1aa30e6e25a9503be94ce3720ce6c4af649b2412c191a6f800f36dd619270bc2',
	}),
	opus: Object.freeze({
		...
		wasmBytes: 388526,
		wasmSha256: 'cc5577fa2a6c74781b7eb57bd754f7d9b50b2355a83d85b0f0cfe96415607dce',
	}),
	twolame: Object.freeze({
		...
		wasmBytes: 148_312,
		wasmSha256: '8b89b6a12eab302c92960865c6b1c7d33df86d6d8760c8549a8ee38a99ef2b30',
	}),
	vorbis: Object.freeze({
		...
		wasmBytes: 526_926,
		wasmSha256: 'cfa42717394ce29f8af676fb0ad7bff632306f75e536211eb85b7cc5aaf09aa0',
	}),
	wavpack: Object.freeze({
		...
		wasmBytes: 148_868,
		wasmSha256: '5197fb8fd8e6cbef210acad11eb2a9dd8395a519b5fd64ba14a1b4978041b0c5',
	}),
});

const CONTROL_ENTRY_FILES = Object.freeze([
...
const COMMON_DEPENDENCIES = Object.freeze([
	...
	'project-library-runtime/desktop/desktop-audio-codec-operation-contract.js',
	'project-library-runtime/src/common/editor/desktop-codec-provider-catalog.js',
	'project-library-runtime/desktop/audio-codec-stream-helper.js',
	'project-library-runtime/desktop/desktop-audio-stream-contract.js',
	'project-library-runtime/desktop/bundled-flac-stream.js',
	'project-library-runtime/desktop/bundled-mpeg-audio-stream.js',
	'project-library-runtime/src/common/editor/ogg-page-crc.js',
	'project-library-runtime/desktop/bundled-opus-stream.js',
	'project-library-runtime/desktop/bundled-vorbis-stream.js',
	'project-library-runtime/desktop/bundled-wavpack-stream.js',
	'project-library-runtime/src/common/editor/browser-dedicated-audio-codec.js',
	'project-library-runtime/src/common/editor/browser-dedicated-audio-profiles.js',
