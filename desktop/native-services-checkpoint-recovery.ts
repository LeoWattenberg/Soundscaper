...
export async function verifyAndStoreNativeImageSequenceCheckpoint(
	record: NativeQueueRecordV2,
	input: NativeImageSequenceCheckpointInputV1,
	...
	const evidence = admitNativeImageSequenceCheckpointEvidence(record, input);
...
export async function recoverNativeImageSequenceCheckpoint(
...
function checkpointAuthority(record: NativeQueueRecordV2): Readonly<{
	...
	return Object.freeze({
		...
		sourceInventoryDigest: nativeImageSequenceSourceInventoryDigest(record),
