...
const CODECS: Readonly<Record<BundledAudioCodecId, Readonly<CodecSpec>>> = Object.freeze({
	flac: Object.freeze({
		...
		providerId: (target) => `bundled-libflac-wasm-${target}`,
	}),
	lame: Object.freeze({
		...
		providerId: (target) => `bundled-lame-wasm-${target}`,
	}),
	mpg123: Object.freeze({
		...
		providerId: (target) => `bundled-mpg123-wasm-${target}`,
	}),
	opus: Object.freeze({
		...
		providerId: (target) => `bundled-libopus-libogg-wasm-${target}`,
	}),
	twolame: Object.freeze({
		...
		providerId: (target) => `bundled-twolame-wasm-${target}`,
	}),
	vorbis: Object.freeze({
		...
		providerId: (target) => `bundled-libvorbis-libogg-wasm-${target}`,
	}),
	wavpack: Object.freeze({
		...
		providerId: (target) => `bundled-wavpack-wasm-${target}`,
	}),
});
