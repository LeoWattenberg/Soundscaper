...
/**
 * The example recordings the lessons import.
 *
 * Each entry describes a short synthetic WAV file well enough for a reader to
 * know what the lesson is working on and for the browser suite to synthesise
 * the same file on demand (`tests/browser/helpers/lesson-fixtures.js`). Keeping
 * the recipe here, next to the name the prose uses, means a lesson cannot
 * promise a noisy lead-in that the replayed file does not have.
 */

export const LESSON_FIXTURES = Object.freeze({
	'noisy-take': Object.freeze({
		file: 'lesson-noisy-take.wav',
		seconds: 3,
		channels: 2,
