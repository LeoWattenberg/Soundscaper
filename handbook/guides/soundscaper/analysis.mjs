...
export const ANALYSIS_GUIDES = Object.freeze([
	{
		id: 'measure-loudness',
		...
		tips: [
			...
			'If the numbers are far from the target, run [Loudness Normalization](guide:normalize-loudness-for-podcasts) and measure again.',
		],
	},
	{
		id: 'plot-a-spectrum',
		...
		tips: [
			...
			'A tall narrow spike is a tone; a broad plateau is noise. Tones respond to a narrow EQ cut, noise to [Noise Reduction](guide:remove-background-noise).',
		],
	},
	{
		id: 'find-clipping',
