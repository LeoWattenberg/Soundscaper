...
sidebar:
  order: 3
---
<!-- docs-ai-provenance: {"factPacketSha256":"71097403d87aba03cddc2ccd696ff9a8663268afba3a7bf750fe8d9913de3eba","model":"qwen3.8:latest","modelDigest":"22130167c4c20e20c7b71454612966ca8e8171e9b3cc8ab6ce8aa6cbfec79643","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"71097403d87aba03cddc2ccd696ff9a8663268afba3a7bf750fe8d9913de3eba","targetLocale":"gl"} -->
...
dalgo que ti debes proporcionar, ou só é accesible traballando arredor dunha
ausencia.
...
- As filas de **Soundscaper** proceden deste repositorio: os perfís de
  capacidade do produto, o manifesto de accións de tempo de execución e o
  rexistro de formatos de exportación. As cargas de destino nativas de
  escritorio xéranse mediante CI do repositorio ou empaquetado de destino. Un
...
| Funciona sen conta | Si — non existe conta | Si — só inicio de sesión para audio.com | Non — requírese subscrición con inicio de sesión |
| Almacenamento de proxectos na nube | Non — excluído polo deseño local primeiro | Si — gardar e compartir a través de audio.com | Parcial — ficheiros de Creative Cloud, as sesións non se sincronizan |
...
| Liña de tempo de clips non destructiva | Si | Si | Si — editor multirrastre |
| Editor de ficheiro único dedicado | Parcial — a edición de mostras faise na liña de tempo | Parcial — as edicións aplícanse no sitio na liña de tempo | Si — editor de forma de onda |
| Contido mono e estéreo nunha pista | Si — unha pista contén calquera | Non — unha pista é mono ou estéreo | Non — o formato de canal está fixado por pista |
...
| Mapas de tempo e clave | Si — mapas ordenados resoltos con precisión de mostra | Parcial — un tempo e clave de proxecto | Parcial — un tempo de sesión |

## Gravación

| Capacidade | Soundscaper | Audacity 4 | Audition |
| --- | --- | --- | --- |
| Gravación multirrastre | Si — varias fontes á vez | Parcial — un dispositivo de entrada á vez | Si — interfaces de múltiples entradas e multicanal |
| Micrófono e audio de escritorio xuntos | Si — integrado | Non | Parcial — require un dispositivo de retroalimentación do sistema operativo |
| Gravación temporizada | Si | Si | Non |
| Gravación activada por son | Si — cun limiar axustable | Si — cun limiar axustable | Non |
| Conteo antes da toma | Si — consciente do mapa de tempo, manexa compás composto | Parcial — gravación de introdución | Parcial — pre-roll como parte de punch and roll |
...
| Ton e velocidade por clip | Si — axustar, renderizar ou reiniciar | Si — axustar, renderizar ou reiniciar | Parcial — o estiramento permanece editable, o ton é un efecto |
...
| Dibuño a nivel de mostra | Si | Parcial — non hai acción de debuxo rexistrada na versión fixada | Si — no editor de forma de onda |
...
| Capacidade | Soundscaper | Audacity 4 | Audition |
| --- | --- | --- | --- |
| Suite de efectos integrados | Si — os 30 efectos de Audacity, complementos Nyquist empaquetados e efectos de primeira parte sen equivalente a montante, como o bitcrusher | Si — a mesma colección integrada de 30 efectos | Si — arredor de cincuenta, incluíndo dinámica multibanda |
...
| Macros e cadeas por lotes | Si — biblioteca de macros gardadas con modelos | Non — a versión fixada comenta o menú Macros | Si — Favoritos e Proceso por lotes |
| Formatos de complementos de terceiros | Parcial — efectos VST3, CLAP, AU, LV2 e LADSPA de Linux máis analizadores Vamp en escritorio baixo consentimento e contención; ningunha no navegador | Si — VST3, AU, LV2 e Nyquist, cun xestor de complementos | Parcial — VST3 e AU en macOS, sen CLAP nin LV2 |
...
| Capacidade | Soundscaper | Audacity 4 | Audition |
| --- | --- | --- | --- |
| Mezclador con tiras de canal | Si | Parcial — controis de pista e unha pista mestra | Si |
| Barras e submezclas | Si — anidadas, con validación de ciclo | Non | Si — pistas de barra |
| Envolventes | Si — pre e post fader, múltiples asignacións | Non | Si — pre e post fader |
| Grupos VCA | Si | Non | Non |
| Entrada de cadea lateral | Si | Non | Si — a través de envolventes |
| Mezclas de pista e sala de control | Si | Non | Non |
| Compensación de atraso de complementos | Si — reprodución, monitorización, barras, cadeas laterais, renderizado e conxelación | Parcial — non exposto nas fontes fixadas | Si |
| Carrís de automatización | Si — ganancia, panorámica, silencio, envolventes, barras e parámetros de complementos | Non — sen carrís nin ferramenta de envolvente na versión fixada | Si — volume, panorámica e parámetros de efectos |
...
| Ajustes personalizados de codificador | Si — un obxectivo FFmpeg personalizado | Si — un obxectivo FFmpeg personalizado | Si — opcións por formato |
...
| Entrega rexión a rexión | Si — secuencias de mestura con metadatos por rexión, espazos e fundidos | Parcial — exportación de etiquetas, sen exportación de múltiples ficheiros na versión fixada | Si — exportación de marcadores a ficheiros separados |
...
| Transcripción e diarización | Parcial — só escritorio, modelos optativos | Non | Non — as transcripcións están en Premiere Pro |
| Separación de fontes en stems | Parcial — só escritorio, modelos optativos | Non | Non |
| Ducking automático | Si — efecto Auto Duck | Si — efecto Auto Duck | Si — ducking de Essential Sound |
| Detección de compás e disparos | Parcial — só escritorio, modelos optativos | Non | Parcial — Remix retemporiza a música automaticamente |
...
| Os modelos son opcionais e eliminables | Si — descargados separadamente, fixados por resumo, eliminables | Si — nada que instalar | Non — incluídos coa aplicación |
