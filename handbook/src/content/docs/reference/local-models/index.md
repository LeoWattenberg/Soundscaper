...
| [wav2vec2 base 960h word alignment](/reference/local-models/wav2vec2-base-960h/) | word alignment | Signed catalog publication pending | `wav2vec2-word-alignment` |
| [TIGER dialogue, music, and effects](/reference/local-models/tiger-dnr/) | source separation | Signed catalog publication pending | `tiger-dialogue-music-effects` |
| [PANNs CNN10 audio tags](/reference/local-models/panns-cnn10/) | audio tagging | Signed catalog publication pending | `panns-audio-tags` |
| [Beat This small](/reference/local-models/beat-this-small0/) | beat tracking | Signed catalog publication pending | `beat-this-small-beats` |
| [Beat This final](/reference/local-models/beat-this-final0/) | beat tracking | Signed catalog publication pending | `beat-this-final-beats` |
| [TransNetV2 shot detection](/reference/local-models/transnetv2/) | shot detection | Signed catalog publication pending | `transnet-accurate-shots` |
| [Qwen3 4B editorial proposals](/reference/local-models/qwen3-4b-q4-k-m/) | editorial generation | Signed catalog publication pending | `qwen-editorial-proposals` |
| [Room dereverberation](/reference/local-models/dereverb-room/) | dereverberation | Signed catalog publication pending | `dereverb-room-speech` |
