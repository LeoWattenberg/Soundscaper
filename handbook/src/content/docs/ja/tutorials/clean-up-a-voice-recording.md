...
---
<!-- docs-ai-provenance: {"factPacketSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","model":"gpt-5.6-luna","modelDigest":"manual","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","targetLocale":"ja"} -->
...
2. **ファイル → インポート** を選択し、`guide-noisy-take.wav` を選択します。これは、音声が始まる前の最初の0.5秒がルームノイズである短いテイクです。ファイルは独自のトラック上にクリップとして配置されます。
