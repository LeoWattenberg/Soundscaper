...
---
<!-- docs-ai-provenance: {"factPacketSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","model":"aya-expanse:32b","modelDigest":"1603440383bd5504dc7afd01c0407b425b988dde650a8dc1a737433baa3cd432","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","targetLocale":"nl"} -->

<!-- Generated by `node scripts/docs-reference.mjs`. Do not edit. -->

De meeste opnames gemaakt thuis hebben dezelfde drie reparaties nodig: een constante achtergrondruis om te verwijderen, een lage rommel om te filteren en een niveau dat naar een standaard moet worden gebracht. Deze handleiding voert alle drie uit op een voorbeeld van drie seconden waarvan de eerste half seconde alleen maar kamerruis is, en exporteert het resultaat als een MP3.

:::tip[Wat je nodig hebt]
- Download [`guide-noisy-take.wav`](https://assets.soundscaper.org/guides/examples/guide-noisy-take.wav) — een korte opname waarvan de eerste half seconde kamerruis is voordat de stem begint.
...
- Waarom ruisreductie een profiel nodig heeft en hoe je dat kunt geven.
- Wat een hoogdoorlaatfilter verwijdert en waar je het moet instellen voor spraak.
- Het verschil tussen piekniveau en luidheid, en hoe je een luidheiddoel kunt bereiken.
- Hoe je een MP3 kunt exporteren.

## Stappen

1. Open Soundscaper. Een nieuw, leeg project is klaar zodra de editor is geladen.
2. Kies **Bestand → Importeren** en kies `guide-noisy-take.wav` — een korte opname waarvan de eerste half seconde kamerruis is voordat de stem begint. Het komt terecht als een clip op zijn eigen spoor.
3. Druk op **Afspelen** om te luisteren, en dan op **Stop**.
   *Je zou moeten zien:* Een halve seconde ruis, gevolgd door een constante toon die een stem vertegenwoordigt, met de ruis eronder.
4. Sleep in de heerser boven de clip, van het begin tot het 15% punt, om het ruis-alleen voorspel te selecteren. Het profiel mag niets bevatten behalve de ruis die je wilt verwijderen — geen stem.
5. Kies **Effect → Ruisverwijdering en herstel → Ruisreductie** en druk op **Ruisprofiel ophalen**. De statusregel meldt dat het profiel klaar is. Druk op **Sluiten** om het dialoogvenster voorlopig te verlaten.
6. Kies **Selecteren → Alles selecteren**. Het profiel wordt bewaard; nu moet het effect weten wat het moet schoonmaken.
7. Kies **Effect → Ruisverwijdering en herstel → Ruisreductie**. In het **Ruisreductie** dialoogvenster, stel **Ruisreductie** in op `12`, en druk dan op **Toepassen op selectie**. Twaalf decibel is een goede eerste instelling. Meer verwijdert meer ruis maar maakt stemmen hol klinken.
   *Je zou moeten zien:* Het voorspel is bijna plat en de toon is ongemoeid.
8. Kies **Effect → Erfgoedeffecten → Klassieke filters**. In het **Klassieke filters** dialoogvenster, kies **Hoogdoorlaat** voor **Filtertype** en stel **Snijfrequentie** in op `100`, en druk dan op **Toepassen op selectie**. Alles onder 100 Hz — verkeer, hantering, airconditioning — wordt weggerold. Spraak leeft goed erboven.
9. Kies **Effect → Volume en compressie → Luidheid normalisatie**. In het **Luidheid normalisatie** dialoogvenster, stel **Doelluidheid** in op `-16`, en druk dan op **Toepassen op selectie**. −16 LUFS is het gangbare doel voor stereo podcasts. Luidheid meet hoe luid de hele opname aanvoelt, niet hoe hoog zijn pieken zijn.
...
10. Druk op **Afspelen** om te luisteren, en dan op **Stop**.
   *Je zou moeten zien:* Een schone, vlakke opname met een rustig voorspel.
11. Kies **Bestand → Audio exporteren**, stel **Formaat** in op **MP3**, en druk op **Exporteren**. Het bestand wordt gedownload zodra de render klaar is, en de link blijft in het dialoogvenster. Het bestand wordt in de browser gecodeerd; er verlaat niets je computer.
...
[Zet muziek onder een stem](/tutorials/put-music-under-a-voice/) — Leg twee sporen op elkaar, laat er automatisch één onder de ander zinken, mix ze af en exporteer.
