...
2. Choose **File → Import audio** and pick the recording to publish. The file lands as a clip on its own track.
3. Choose **File → Export audio**, set **Format** to **MP3**, and press **Export**. The file downloads as soon as the render finishes, and its link stays in the dialog. The file is encoded in the browser; nothing leaves your computer.
