...
| Apply preset | `action://effects/presets/apply` | — | Effect dialogue > Presets | Soundscaper | Audacity |
...
| Centre view on playhead | `center-view-on-playhead` | — | View > Zoom | Soundscaper, Framescaper | Audacity |
| Centiseconds | `snap-centiseconds` | — | View > Snapping > Seconds and samples | Soundscaper, Framescaper | Soundscaper local |
| Change clip colour | `action://trackedit/clip/change-color?colorindex=%1` | — | Clip context > Colour | Soundscaper, Framescaper | Audacity |
...
| Change track colour | `action://trackedit/track/change-color?colorindex=%1` | — | Track context > Colour | Soundscaper, Framescaper | Audacity |
...
| Copy labelled audio | `copy-labels` | Alt+Shift+C | Edit > Labelled audio | Soundscaper | Audacity |
...
| Cut labelled audio | `cut-labels` | Alt+X | Edit > Labelled audio | Soundscaper | Audacity |
| Cut labelled audio and leave gap | `split-cut-labels` | Alt+Shift+X | Edit > Labelled audio | Soundscaper | Audacity |
...
| Delete labelled audio | `delete-labels` | Alt+K | Edit > Labelled audio | Soundscaper | Audacity |
| Delete labelled audio and leave gap | `split-delete-labels` | Alt+Shift+K | Edit > Labelled audio | Soundscaper | Audacity |
| Delete preset | `action://effects/presets/delete` | — | Effect dialogue > Presets | Soundscaper | Audacity |
...
| Detach labelled audio at silences | `disjoin-labels` | Alt+Shift+J | Edit > Labelled audio | Soundscaper | Audacity |
...
| Export preset | `action://effects/presets/export` | — | Effect dialogue > Presets | Soundscaper | Audacity |
...
| Follow track colour | `action://trackedit/clip/change-color-auto` | — | Clip context > Colour | Soundscaper, Framescaper | Audacity |
...
| Import preset | `action://effects/presets/import` | — | Effect dialogue > Presets | Soundscaper | Audacity |
...
| Join labelled audio | `join-labels` | Alt+J | Edit > Labelled audio | Soundscaper | Audacity |
...
| Loudness Normalisation | `audacity-loudness-normalization` | — | Effect > Volume and compression | Soundscaper | Soundscaper local |
...
| Managed Colour & Source Interpretation | `framescaper-color-management` | — | Effect > Video Finishing | Framescaper | Soundscaper local |
...
| Normalise | `audacity-normalize` | — | Effect > Volume and compression | Soundscaper | Soundscaper local |
...
| Repeat last analyser | `local://repeat-analyzer` | — | Analyze | Soundscaper | Soundscaper local |
...
| Save preset | `action://effects/presets/save` | — | Effect dialogue > Presets | Soundscaper | Audacity |
| Save preset as | `action://effects/presets/save_as` | — | Effect dialogue > Presets | Soundscaper | Audacity |
...
| Silence labelled audio | `silence-labels` | Alt+L | Edit > Labelled audio | Soundscaper | Audacity |
...
| Split labelled audio | `split-labels` | Alt+I | Edit > Labelled audio | Soundscaper | Audacity |
| Split stereo to L/R mono | `track-split-stereo-to-lr` | — | Track context | Soundscaper, Framescaper | Audacity |
| Split stereo to centre mono | `track-split-stereo-to-center` | — | Track context | Soundscaper, Framescaper | Audacity |
