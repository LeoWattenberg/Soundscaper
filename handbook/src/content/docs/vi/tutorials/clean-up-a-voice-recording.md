...
2. Chọn **Tệp → Nhập** và chọn `guide-noisy-take.wav` — một đoạn ngắn mà nửa giây đầu tiên là tiếng ồn phòng trước khi giọng nói bắt đầu. Tệp rơi xuống dưới dạng đoạn cắt trên đường ray riêng của nó.
