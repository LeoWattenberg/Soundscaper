...
1. Следуйте обучающему материалу [Ваш первый проект Soundscaper](/tutorials/your-first-project/).
2. [Настройте запись](/soundscaper/recording/), если вам нужен новый материал.
3. [Редактируйте, смешивайте и экспортируйте](/soundscaper/edit-mix-and-export/).
4. Ознакомьтесь с [поведением хранения и резервного копирования](/projects-and-data/storage-backups-and-privacy/).
