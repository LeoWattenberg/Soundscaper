...
11. Choose **File → Export audio**, set **Format** to **MP3** and press **Start export**. When the render finishes, a download link for the `.mp3` file appears in the dialog. The file is encoded in the browser; nothing leaves your computer.
