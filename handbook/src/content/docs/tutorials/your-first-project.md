...
11. Choose **File → Export audio**, set **Format** to **WAV** and press **Start export**. When the render finishes, a download link for the `.wav` file appears in the dialog. An export renders what you hear into a file for other programs. It does not change the project.
