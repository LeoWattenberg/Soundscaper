...
description: "Meça o quão alto uma voz se destaca do ruído de fundo, conforme solicitado pelas diretrizes de acessibilidade."
editUrl: false
sidebar:
  order: 5
head:
...
2. Escolha **Arquivo → Importar** e selecione a gravação com fala sobre ruído de fundo. Ela é colocada como um clipe em sua própria faixa.
3. Arraste a régua acima do clipe para selecionar um trecho de fundo sem fala. A medição do fundo deve conter apenas o ruído que a voz precisa superar.
...
- [Encontrar onde uma gravação clipping](/guides/analysis/find-clipping/) — Localize os lugares onde uma gravação atingiu o limite e distorceu.
