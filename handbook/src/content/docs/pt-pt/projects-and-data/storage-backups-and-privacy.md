...
description: "Compreenda o armazenamento local-primeiro e proteja os projetos de perdas no navegador ou dispositivo."
sidebar:
  order: 3
---
...
Projetos, gravações e mídia importada são processados e armazenados no seu
...
disponível, com IndexedDB como alternativa. O Soundscaper solicita armazenamento persistente,
mas o navegador decide se deve ou não concedê-lo.

## O que pode remover um projeto

- Limpar os dados do site remove a biblioteca de projetos local do navegador.
- Contextos de navegador privados ou restritos podem recorrer à memória temporária.
- As políticas de cota e despejo do navegador permanecem autoritárias.
...
Este manual é servido como arquivos estáticos e utiliza pesquisa local do navegador. O site V1 não adiciona um serviço de análise ou um backend de AI/pesquisa.

A política completa de [privacidade Soundscaper e Framescaper](https://soundscaper.org/privacy/en/)
também abrange a entrega de aplicativos, permissões do dispositivo, downloads opcionais,
