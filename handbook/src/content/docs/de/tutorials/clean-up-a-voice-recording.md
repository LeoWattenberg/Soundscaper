...
---
<!-- docs-ai-provenance: {"factPacketSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","model":"gpt-5.6-luna","modelDigest":"manual","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","targetLocale":"de"} -->
...
- Warum ein Profil für die Rauschreduzierung benötigt wird und wie Sie eines erstellen.
...
2. Wählen Sie **Datei → Audio importieren** und wählen Sie `guide-noisy-take.wav` — eine kurze Aufnahme, deren erste halbe Sekunde nur Rauschen enthält, bevor die Stimme einsetzt. Die Datei erscheint als Clip auf einer eigenen Spur.
...
4. Ziehen Sie im Lineal über dem Clip vom Anfang bis zur 15-%-Marke, um den rauschenden Anfangsabschnitt auszuwählen. Das Profil darf nur das Rauschen enthalten, das Sie entfernen möchten — keine Stimme.
...
7. Wählen Sie **Effekt → Rauschentfernung und -reparatur → Rauschreduzierung**. Im **Rauschreduzierung**-Dialog setzen Sie **Rauschreduzierung** auf `12` und drücken Sie dann **Auf Auswahl anwenden**. Zwölf Dezibel sind eine gute erste Einstellung. Höhere Werte entfernen mehr Rauschen, lassen Stimmen aber hohl klingen.
   *Sie sollten sehen:* Der Anfangsabschnitt ist fast eben und der Ton bleibt unverändert.
8. Wählen Sie **Effekt → Legacy-Effekte → Klassische Filter**. Im **Klassische Filter**-Dialog wählen Sie **Hochpass** als **Filtertyp** und setzen **Schnittfrequenz** auf `100`, dann drücken Sie **Auf Auswahl anwenden**. Alles unter 100 Hz — Verkehr, Handhabungsgeräusche, Klimaanlage — wird abgeschwächt. Sprache liegt deutlich darüber.
...
11. Wählen Sie **Datei → Audio exportieren**, setzen Sie **Format** auf **MP3** und drücken Sie **Exportieren**. Die Datei wird heruntergeladen, sobald das Rendering abgeschlossen ist, und der Link bleibt im Dialogfeld. Die Datei wird im Browser codiert; nichts verlässt Ihren Computer.
