...
2. Choose **File → Import** and pick the recording that needs warming or brightening. If the file appears in the Project bin, press **Add to timeline**. It lands as a clip on its own track.
