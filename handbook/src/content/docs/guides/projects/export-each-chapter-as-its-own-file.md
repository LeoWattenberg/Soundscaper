...
2. Choose **File → Import** and pick the recording to split. If the file appears in the Project bin, press **Add to timeline**. It lands as a clip on its own track.
