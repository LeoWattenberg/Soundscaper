...
2. Choose **File → Import** and pick the first track to mix. If the file appears in the Project bin, press **Add to timeline**. It lands as a clip on its own track.
3. Choose **File → Import** and pick the second track to mix. If the file appears in the Project bin, press **Add to timeline**. It lands as a clip on its own track.
