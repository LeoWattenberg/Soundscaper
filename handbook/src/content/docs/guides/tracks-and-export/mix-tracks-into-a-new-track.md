...
2. Choose **File → Import** and pick the first track to mix. The file lands as a clip on its own track.
3. Choose **File → Import** and pick the second track to mix. The file lands as a clip on its own track.
