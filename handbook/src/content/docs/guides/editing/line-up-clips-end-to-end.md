...
2. Choose **File → Import** and pick the first take. It lands as a clip on its own track.
3. Choose **File → Import** and pick the second take. It lands as a clip on its own track.
