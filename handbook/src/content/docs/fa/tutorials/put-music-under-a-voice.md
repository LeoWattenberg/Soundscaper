---
title: "قرار دادن موسیقی زیر یک صدا"
...
---
<!-- docs-ai-provenance: {"factPacketSha256":"e4981b16b64b467101c91ffa64c89547deeab7140978a77f6e5c8fadef3db7e6","model":"aya-expanse:32b","modelDigest":"1603440383bd5504dc7afd01c0407b425b988dde650a8dc1a737433baa3cd432","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"e4981b16b64b467101c91ffa64c89547deeab7140978a77f6e5c8fadef3db7e6","targetLocale":"fa"} -->

<!-- Generated by `node scripts/docs-reference.mjs`. Do not edit. -->

یک مقدمه پادکست، یک صداگذاری ویدیویی، یک بستر رادیویی: موسیقی باید هر زمان که صدا صحبت می‌کند، قطع شود و در فواصل بازگردد. این آموزش از دو حلقه نمونه - یکی به عنوان صدا و دیگری برای موسیقی - استفاده می‌کند تا با استفاده از Auto Duck، آن رابطه را ایجاد کند، سپس دو مسیر را به یک مسیر مخلوط می‌کند و آن را صادر می‌کند.
...
- آنچه مسیر کنترل است و نحوه استفاده Auto Duck از آن.
- نحوه مخلوط کردن چندین مسیر به یک مسیر.
...
3. **فایل → واردات** را انتخاب کنید و `guide-second-loop.wav` — یک حلقه دو ثانیه‌ای دیگر را برای لایه‌گذاری روی آن انتخاب کنید. آن به عنوان یک کلیپ در مسیر خود قرار می‌گیرد.
4. **پلی** را فشار دهید تا گوش دهید، سپس **توقف** را فشار دهید.
   *شما باید ببینید:* هر دو حلقه با هم پخش می‌شوند، هر کدام در مسیر خود.
5. روی نوار نام `guide-music-loop.wav` کلیک کنید تا آن را انتخاب کنید. کلیپی که انتخاب می‌کنید، همان کلیپی است که قرار است «داک» شود — موسیقی، نه صدا.
6. **اثر → حجم و فشردگی → Auto Duck** را انتخاب کنید. در پنجره گفتگوی **Auto Duck**، **guide-second-loop** را برای **مسیر کنترل** و **میزان داک** را به `-12` تنظیم کنید، سپس **اعمال به انتخاب** را فشار دهید. هر جا که مسیر کنترل از آستانه بلندتر باشد، مسیر انتخاب شده به میزان داک کم می‌شود، با محو شدن در لبه‌ها.
   *شما باید ببینید:* فرم موج موسیقی هر جا که صدا در حال پخش است، کوچکتر است.
...
8. روی نوار نام `guide-music-loop.wav` کلیک کنید، سپس در حالی که Shift را نگه داشته‌اید، روی نوار نام `guide-second-loop.wav` کلیک کنید، تا هر دو انتخاب شوند. هر مسیری که کلیپ انتخاب شده در آن باشد، در مخلوط قرار می‌گیرد.
9. **مسیرها → مخلوط و رندر** را انتخاب کنید. در پنجره گفتگوی **مخلوط و رندر**، **مخلوط کردن**، **رندر اثرات** و **جایگزینی اصلی‌ها** را فعال نگه دارید، **استریو** را برای **مخلوط کردن به** انتخاب کنید، سپس **مخلوط و رندر** را فشار دهید.
10. پروژه اکنون یک کلیپ با نام **مخلوط** نشان می‌دهد.
   *شما باید ببینید:* یک مسیر یک کلیپ به نام مخلوط را نگه می‌دارد؛ دو مسیر منبع ناپدید شده‌اند. **ویرایش → بازگردانی** آن‌ها را بازمی‌گرداند.
11. **فایل → صادرات صوتی** را انتخاب کنید، **فرمت** را به **MP3** تنظیم کنید و **صادرات** را فشار دهید. فایل به محض اتمام رندر دانلود می‌شود و لینک آن در گفتگو باقی می‌ماند.

## مراحل بعدی

- همان کار را با مواد خودتان انجام دهید: [داک کردن موسیقی زیر یک صدا](/guides/volume/duck-music-under-a-voice/) و [مخلوط کردن چندین مسیر به یک مسیر](/guides/tracks-and-export/mix-tracks-into-one/).
- قطعات را جدا نگه دارید تا شخص دیگری آن‌ها را مخلوط کند: [صادرات هر مسیر به عنوان یک فایل جداگانه](/guides/projects/export-each-track-as-its-own-file/).

## آموزش‌های دیگر

[اولین پروژه Soundscaper شما](/tutorials/your-first-project/) — یک ضبط را وارد کنید، به آن گوش دهید، آن را تقسیم کنید، محو کنید، یک فایل را صادر کنید و پروژه را ذخیره کنید.
[پاک کردن یک ضبط صدا](/tutorials/clean-up-a-voice-recording/) — صدای زمزمه را از یک ضبط حذف کنید، لرزش را قطع کنید، آن را به صدای پادکست برسانید و یک MP3 صادر کنید.
...
این آموزش، قدم به قدم و بر روی همین فایل‌ها، در هر نسخه Soundscaper توسط مجموعه مرورگر (`tests/browser/soundscaper-tutorials.spec.js`) تکرار می‌شود. اگر هر مرحله‌ای از کار بیفتد، نسخه مرورگر تا زمان اصلاح آموزش، شکست می‌خورد، بنابراین آنچه می‌خوانید، همان کاری است که ویرایشگر انجام می‌دهد.
