...
---
<!-- docs-ai-provenance: {"factPacketSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","model":"aya-expanse:32b","modelDigest":"1603440383bd5504dc7afd01c0407b425b988dde650a8dc1a737433baa3cd432","operation":"translate","promptVersion":"docs-translate-v1","schemaVersion":1,"sourceLocale":"en","sourceSha256":"96727487ae82c7f76b646047856630f73eb756ee7832615587e24e1e6db0b0ee","targetLocale":"fa"} -->
...
2. **فایل → وارد کردن** را انتخاب کنید و `guide-noisy-take.wav` — یک نمونه کوتاه که نیم ثانیه اول آن فقط نویز اتاق است و بعد از آن صدا شروع می‌شود — را انتخاب کنید. آن به عنوان یک کلیپ در یک مسیر جداگانه قرار می‌گیرد.
3. **پلی** را فشار دهید تا گوش دهید، سپس **استاپ** را فشار دهید.
   *باید ببینید:* نیم ثانیه صدای زمزمه، سپس یک تون ثابت به جای یک صدا، با صدای زمزمه زیر آن.
4. در بالای کلیپ، از شروع تا علامت 15%، کشیده شود تا نویز مقدماتی انتخاب شود. پروفایل باید فقط حاوی نویز مورد نظر باشد — هیچ صدایی نداشته باشد.
...
9. **اثر → حجم و فشرده‌سازی → نرمال‌سازی صدا** را انتخاب کنید. در دیالوگ **نرمال‌سازی صدا**، **صدای بلند هدف** را به `-16` تنظیم کنید، سپس **اعمال به انتخاب** را فشار دهید. -16 LUFS هدف رایج برای پادکست‌های استریو است. صدای بلند نحوه احساس کل نمونه را اندازه‌گیری می‌کند، نه ارتفاع اوج‌ها را.
   *باید ببینید:* موج‌نگار بلندتر است و نمونه در یک سطح راحت پخش می‌شود.
10. **پلی** را فشار دهید تا گوش دهید، سپس **استاپ** را فشار دهید.
   *باید ببینید:* یک نمونه تمیز و سطحی با یک مقدمه آرام.
11. **فایل → صادر کردن صوت** را انتخاب کنید، **فرمت** را به **MP3** تنظیم کنید، و **صادر کردن** را فشار دهید. فایل به محض اتمام رندر دانلود می‌شود و لینک آن در دیالوگ باقی می‌ماند. فایل در مرورگر رمزگذاری می‌شود؛ هیچ چیز از کامپیوتر شما خارج نمی‌شود.

## مرحله بعدی

- آن را بر روی نمونه خود با راهنماهای چگونه انجام دهید: [حذف نویز پس‌زمینه](/guides/cleaning-up/remove-background-noise/)، [حذف لرزش کم](/guides/cleaning-up/remove-low-rumble/) و [نرمال‌سازی صدا برای یک پادکست](/guides/volume/normalize-loudness-for-podcasts/).
...
[موسیقی را زیر یک صدا قرار دهید](/tutorials/put-music-under-a-voice/) — دو مسیر را لایه‌بندی کنید، یکی را زیر دیگری به طور خودکار پایین بیاورید، آن‌ها را مخلوط کنید و صادر کنید.
...
- [فرمت‌های صادر کردن، کانتینرهای آن‌ها و محدودیت‌های کانال آن‌ها در مرجع فرمت‌های صادر کردن است.](/reference/generated/formats/)
- [هر دستور منو و میانبر صفحه‌کلید آن در مرجع دستورات و میانبرها است.](/reference/generated/commands/)

## در مورد این آموزش

این آموزش، قدم به قدم و بر روی همین فایل‌ها، در برابر هر نسخه Soundscaper توسط مجموعه مرورگر (`tests/browser/soundscaper-tutorials.spec.js`) تکرار می‌شود. اگر یک مرحله دیگر کار نکند، نسخه تا زمانی که آموزش اصلاح شود، شکست می‌خورد، بنابراین آنچه می‌خوانید همان کاری است که ویرایشگر انجام می‌دهد.
