...
test('the current V14 feature requirements retain their compatibility semantics through a Scape round trip', async () => {
...
test('pre-open Scape inspection leaves future project feature requirements opaque', async () => {
	...
	assert.equal(inspected.schemaVersion, 15);
