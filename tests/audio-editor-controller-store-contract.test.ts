...
import type { ImportCompositionStore } from '../src/common/editor/controller/import-composition-types.ts';
import type { RecordingCompositionStore } from '../src/common/editor/controller/recording-composition-types.ts';
