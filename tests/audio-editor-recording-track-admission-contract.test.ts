...
import { createRecordingSessionService } from '../src/common/editor/controller/recording-session-service.ts';
import type { RecordingCompositionDependencies } from '../src/common/editor/controller/recording-composition-types.ts';
import type { createEditorTrackService } from '../src/common/editor/controller/track-service.ts';
