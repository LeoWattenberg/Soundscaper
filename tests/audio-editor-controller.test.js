...
test('headless audio editor exposes cached snapshots, subscriptions, and frame-accurate grouped actions', async () => {
	...
	assert.deepEqual(Object.keys(controller.actions), [
		'project', 'projectBin', 'video', 'edit', 'transport', 'recording', 'metering', 'audioDevices', 'storage', 'timeline', 'timelineAnnotations', 'sequences', 'trackFolders', 'takeComp', 'sampleEdit', 'spectral',
