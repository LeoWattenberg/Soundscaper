...
test('Framescaper v1 imports and exports caption files and publishes built-in motion analysis', async ({ page }) => {
	...
	await expect(exportDialog.locator('[data-export-field="captionDeliveryUnavailable"]')).toContainText(
		'Caption burn-in and mux are unavailable for Framescaper 1.0. '
			+ 'Export SRT, WebVTT, or IMSC 1.1 sidecars from Tracks > Caption Tracks.',
	);
