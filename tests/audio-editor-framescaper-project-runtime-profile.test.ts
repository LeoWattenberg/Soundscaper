...
test('keeps final-profile consumption within the closed maintained Framescaper product set', async () => {
	...
	assert.deepEqual(genericPathReferences, [
		...
		'src/soundscaper/desktop-project-library-v10-delete-intents.ts',
		'src/soundscaper/desktop-project-library-v10-renderer-catalog.ts',
		'src/soundscaper/desktop-project-library-v10-renderer-contract.ts',
