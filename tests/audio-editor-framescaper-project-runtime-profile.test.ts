...
test('keeps final-profile consumption within the closed maintained Framescaper product set', async () => {
	...
	assert.deepEqual(exportReferences, [
		...
		'src/framescaper/editor-project-v20-runtime.ts',
		...
		'tests/audio-editor-framescaper-desktop-v10-renderer.test.ts',
		'tests/audio-editor-framescaper-desktop-v10-store-adapter.test.ts',
		'tests/audio-editor-framescaper-multicamera-persistence-v18.test.ts',
		'tests/audio-editor-framescaper-multicamera-playback-v18.test.ts',
		'tests/audio-editor-framescaper-multicamera-v18.test.ts',
		'tests/audio-editor-framescaper-nested-playback-v18.test.ts',
		...
		'tests/audio-editor-framescaper-projection-routing-v18.test.ts',
		...
		'tests/audio-editor-framescaper-scape-native-v18.test.ts',
		'tests/audio-editor-framescaper-scape-preservation-v18.test.ts',
		'tests/audio-editor-framescaper-video-proxy-attachment-coordinator-v18.test.ts',
		'tests/audio-editor-framescaper-video-proxy-new-body-root.test.ts',
		'tests/audio-editor-framescaper-video-proxy-preview-v18.test.ts',
		...
		'tests/helpers/framescaper-v18-scape-file-test-support.ts',
	]);
	...
	assert.deepEqual(genericPathReferences, [
		...
		'src/framescaper/desktop-project-library-v17-renderer.ts', 'src/framescaper/desktop-project-library-v17-store-adapter.ts',
		'src/framescaper/desktop-project-library-v18-renderer.ts', 'src/framescaper/desktop-project-library-v18-store-adapter.ts',
		'src/framescaper/desktop-project-library-v19-renderer.ts', 'src/framescaper/desktop-project-library-v19-store-adapter.ts',
		'src/framescaper/desktop-project-library-v20-renderer.ts', 'src/framescaper/desktop-project-library-v20-shadow.ts',
		...
		'src/framescaper/editor-project-v18-multicam-playback.ts',
		'src/framescaper/editor-project-v18-nested-playback.ts',
		...
		'src/soundscaper/desktop-project-library-v10-delete-intents.ts', 'src/soundscaper/desktop-project-library-v10-renderer-catalog.ts',
		'src/soundscaper/desktop-project-library-v10-renderer-contract.ts', 'src/soundscaper/desktop-project-library-v10-renderer-lifecycle.ts',
		'src/soundscaper/desktop-project-library-v10-renderer.ts', 'src/soundscaper/desktop-project-library-v10-store-adapter.ts',
		'src/soundscaper/desktop-project-library-v11-delete-intents.ts', 'src/soundscaper/desktop-project-library-v11-renderer-catalog.ts',
		'src/soundscaper/desktop-project-library-v11-renderer-contract.ts', 'src/soundscaper/desktop-project-library-v11-renderer-lifecycle.ts',
		'src/soundscaper/desktop-project-library-v11-renderer.ts', 'src/soundscaper/desktop-project-library-v11-store-adapter.ts',
		...
		'src/soundscaper/editor-project-runtime-profile-v29.ts', 'src/soundscaper/editor-project-runtime-profile-v30.ts',
		'src/soundscaper/editor-project-v21-profile.ts', 'src/soundscaper/editor-project-v23-profile.ts',
		'src/soundscaper/editor-project-v29-profile.ts', 'src/soundscaper/editor-project-v30-profile.ts',
		...
		'tests/audio-editor-soundscaper-project-v29.test.ts',
