...
export const REACHABILITY_PLACED_TARGETS: ReadonlyMap<string, string> = new Map([
	...
	[
		'src/common/i18n/translation-catalog.js',
		'Site copy leaf: `src/common/site/use-site-copy.js` swaps the translated site strings in through it, so an editor owner would put an editor chunk in the initial graph.',
	],
	[
		'src/common/i18n/translations/index.js',
		'Site copy leaf: the generated loader index `src/common/site/BrandSidebar.jsx` lists translated locales from; every catalog behind it is its own lazy chunk.',
	],
	[
