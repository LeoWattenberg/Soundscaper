...
export function framescaperV32BoundaryImage(
...
export function addFramescaperV32BoundaryImage(
	project: FramescaperProjectV32,
	suffix = '1',
	updatedAt = '2026-08-25T12:00:00.000Z',
) {
	const fixture = framescaperV32BoundaryImage(project, suffix);
	const track = project.tracks.find(({ type, locked }) => type === 'video' && !locked);
	if (!track) throw new ReferenceError('The V32 image fixture requires an unlocked video track.');
	return Object.freeze({
		...fixture,
		project: applyFramescaperProjectCommandV32(
