...
export async function createFixture(context) {
	...
	for (const [path, body] of [
		...
		['playwright.nightly-packaged-coverage.config.mjs', 'export default {};\n'],
		...
		['evidence/nyquist-plugin-publication/catalog-metadata-ed168a19631ec48d0029dfb5c17d16c339a174c1.json', '{"catalog":"fixture"}\n'],
		['tests/fixtures/nyquist-archive/manifest.json.gz', 'fixture manifest\n'],
		['tests/fixtures/nyquist-archive/10bandeq.ny.gz', 'fixture plugin\n'],
		['tests/fixtures/nyquist-archive/NOTICE.md', 'Fixture archive notice\n'],
		['tests/fixtures/nyquist-archive/LICENSE-GPL-2.0.txt', 'GPL-2.0 fixture notice\n'],
		['tests/fixtures/nyquist-archive/LICENSE-GPL-3.0.txt', 'GPL-3.0 fixture notice\n'],
		...
		['desktop/soak-debug-dialog.mjs', 'export const soakDialog = true;\n'],
		['desktop/soak-debug-process-metrics.mjs', 'export const soakMetrics = true;\n'],
		...
		['scripts/lib/product-web-routing.mjs', 'export const routing = true;\n'],
		...
		['scripts/lib/desktop-nightly-tests-packaged-coverage.mjs', 'export const packagedCoverage = true;\n'],
		['scripts/lib/desktop-packaged-product-executable.mjs', 'export const productExecutable = true;\n'],
		...
		['scripts/lib/soundscaper-soak-desktop-playwright.mjs', 'export const desktopSoak = true;\n'],
		['scripts/lib/soundscaper-soak-media.mjs', 'export const soakMedia = true;\n'],
		['scripts/lib/soundscaper-soak-playwright.mjs', 'export const soakPlaywright = true;\n'],
		['scripts/lib/soundscaper-soak-scape-custody.mjs', 'export const soakCustody = true;\n'],
		['scripts/lib/soundscaper-soak-workflows.mjs', 'export const soakWorkflows = true;\n'],
		...
		['scripts/lib/browser-webassembly-coverage.mjs', 'export const browserWebAssemblyCoverage = true;\n'],
		['scripts/lib/cdp-javascript-coverage.mjs', 'export const cdpJavaScriptCoverage = true;\n'],
		['scripts/lib/browser-dynamic-coverage-sources.mjs', 'export const dynamicCoverage = true;\n'],
		...
		['scripts/lib/packaged-executable-resource-identity.mjs', 'export const packagedExecutableResourceIdentity = true;\n'],
		...
		['config/ffmpeg-runtime-publication-policy.json', await readFile(new URL('../../config/ffmpeg-runtime-publication-policy.json', import.meta.url), 'utf8')],
		['.wrangler/dual-origin-browser/soundscaper/.browser-product-build.json', `${JSON.stringify({ schemaVersion: 2, productId: 'soundscaper', origin: 'http://127.0.0.1:4332' })}\n`],
		['.wrangler/dual-origin-browser/soundscaper/en/index.html', '<p>Soundscaper reciprocal fixture</p>'],
		['.wrangler/dual-origin-browser/framescaper/.browser-product-build.json', `${JSON.stringify({ schemaVersion: 2, productId: 'framescaper', origin: 'http://127.0.0.1:4333' })}\n`],
		['.wrangler/dual-origin-browser/framescaper/en/index.html', '<p>Framescaper reciprocal fixture</p>'],
		['.wrangler/dual-origin-browser/soundscaper-source-maps/app.js.map', '{}\n'],
		['.wrangler/dual-origin-browser/framescaper-source-maps/app.js.map', '{}\n'],
