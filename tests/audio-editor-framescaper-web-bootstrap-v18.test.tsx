...
test('the shared Main route selects V27 while the reserved V18 bootstrap remains self-contained', async () => {
	...
	assert.doesNotMatch(main, /FramescaperAudioEditorBootstrapV(?:18|19|20)\.tsx/u);
	assert.ok(
