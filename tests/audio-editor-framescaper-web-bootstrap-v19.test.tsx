...
test('the reserved V19 bootstrap remains unselected when the shared site route selects V20', async () => {
	...
	assert.doesNotMatch(main, /FramescaperAudioEditorBootstrapV19\.tsx/u);
