...
function project(id: string, revision: number, source?: TestSource): AudioEditorProjectV9 {
...
async function putCurrentProject(database: IDBDatabase, value: AudioEditorProjectV9): Promise<void> {
