...
test('product-owned previews exclude the Soundscaper stable tag and any release-admission step', async () => {
	assert.equal(releaseLines.products.soundscaper.candidate.version, '1.0.0-rc.8');
	assert.equal(releaseLines.products.framescaper.candidate.version, '1.0.0-rc.4');
