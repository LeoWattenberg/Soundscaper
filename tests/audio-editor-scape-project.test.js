...
test('V12 timeline annotations survive a current-format scape semantic round trip', async () => {
...
test('a future V13 scape opens read-only without interpreting, rewriting, or persisting its graph', async () => {
