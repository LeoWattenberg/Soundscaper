...
function proposal(options: Readonly<{
	...
	return {
		...
		sourceStartFrame: options.firstSourceFrame,
		sourceEndFrame: options.lastSourceFrame + 1,
		score: 0.875,
		evidenceMode: 'transcript',
		transcriptExcerpt: 'A reviewed transcript cue.',
		visualSummary: 'A reviewed visual summary.',
		selected: false,
