...
function assertClipFallbackRelationship(project: AudioEditorProjectCurrent, fallbackSourceId: string): void {
...
function clipFallback(project: AudioEditorProjectCurrent): ProjectFeatureVideoClipRenderFallback {
