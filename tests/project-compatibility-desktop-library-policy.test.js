...
test('shared desktop project policy pins the current editor handoff boundary', async () => {
	...
	assert.deepEqual(linkedVideoOriginal.evidence, [
		...
		'src/common/editor/controller/project-bin-replacement-service.ts', 'src/common/editor/controller/project-import-options.ts', 'src/common/editor/controller/project-import-service.ts',
