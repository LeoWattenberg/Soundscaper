...
test('nightly test staging creates a hermetic, manifest-bound Playwright payload', async (context) => {
	...
	for (const relativePath of [
		...
		'scripts/lib/local-model-mirror-publication.mjs',
		...
		'scripts/lib/navigation-coverage-checkpoint.mjs',
		'scripts/lib/packaged-executable-resource-identity.mjs',
		'scripts/lib/packaged-webassembly-coverage.mjs',
		...
		'sites/soundscaper/.browser-product-build.json',
		'sites/framescaper/en/index.html',
		'sites/framescaper/.browser-product-build.json',
		...
		'tests/fixtures/nyquist-archive/LICENSE-GPL-2.0.txt',
		'tests/fixtures/nyquist-archive/LICENSE-GPL-3.0.txt',
