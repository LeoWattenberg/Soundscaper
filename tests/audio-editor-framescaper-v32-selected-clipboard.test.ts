...
test('selected V32 runtime copies and pastes an image through V13 with explicit body ownership', async (context) => {
...
function memoryStore(context: TestContext): Store {
	const store = createProjectStore({
		indexedDB: null, preferOpfs: false, databaseName: 'framescaper-v32-selected-clipboard',
	});
