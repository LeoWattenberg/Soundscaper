...
test('frequency waveform analysis and presentation share one opt-in owner', () => {
	...
	const invalidation = sourceRuntime.match(
...
test('stateful local assistance implementations share one dedicated lazy owner', () => {
	for (const path of [
		...
		'src/common/editor/assistance/local-assistance-lazy-semantic-search-bridge.ts',
		'src/common/editor/assistance/local-assistance-lazy-workflow-bridge.ts',
		'src/common/editor/assistance/local-assistance-preparation.ts',
		'src/common/editor/assistance/local-assistance-result-review.ts',
		'src/common/editor/assistance/local-assistance-shot-review.ts',
		'src/common/editor/assistance/local-assistance-workflow-bridge.ts',
...
test('effect dialogs and their design-system shell share one cycle-free lazy owner', () => {
	for (const path of [
		...
		'src/common/editor/ui/inspector/LazyEffectParameterEditor.jsx',
