...
test('the security matrix qualifies maintained save- and activation-triggered linked-original cleanup narrowly', async () => {
	...
	assert.match(control.summary, /relink beyond the exact-content retained-video and linked-PCM Project Bin flows or any automatic watch.*packaged executable or operating-system.*audible or device playback.*third-party activation gating.*legacy private librar/isu);
});
